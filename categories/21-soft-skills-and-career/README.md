# 📂 Soft Skills, Communication & Career Growth

> **Category Directory**: `categories/21-soft-skills-and-career/`  
...
Technical writing, interview preparation, code review etiquette, cross-functional collaboration, and public speaking.
...
- **Writing High-Impact Technical Documentation & RFCs**
- **Code Review Communication & Empathetic Feedback**
- **Public Speaking & Conference Presentation**

### 🔹 Career Advancement
- **System Design & Coding Interview Mastery**
- **Individual Contributor (Staff+) vs Management Tracks**
- **Open Source Contribution & Personal Branding**
...
`Markdown`, `Obsidian`, `Excalidraw`, `LeetCode`
...
```mermaid
flowchart LR
    A[1. Beginner<br/>Foundations & Core Principles] --> B[2. Intermediate<br/>Implementation & Pipelines]
    B --> C[3. Advanced<br/>Optimization & Scale]
    C --> D[4. Expert<br/>Novel Architectures & Research]
```
