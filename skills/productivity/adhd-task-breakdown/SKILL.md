...
description: "Turn overwhelming work into ADHD-friendly, visible, short, immediately actionable steps."
...
source: custom
enabled: true
capabilities: [adhd-task-breakdown, productivity]
inputs: [task, context]
...
2. **Identify phases** — 3 to 7 high-level stages, in order.
