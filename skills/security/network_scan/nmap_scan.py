"""
Modular Skill Component: NmapScanner
Category: security / Module: network_scan
...
class NmapScanner:
    """Implementation of NmapScanner for intent: sec.scan"""

    def __init__(self, event_bus: Optional[Any] = None):
        self.event_bus = event_bus
        self.priority = 60
        self.supported_intent = "sec.scan"
        self.dependencies = []
    ...
    def handle(self, intent_data: Dict[str, Any], context: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "text": f"[NmapScanner] Successfully processed '{intent_data.get('intent')}'",
                "entities": entities
            }
            ...
            return {
                ...
                "skill": "NmapScanner",
                "error": str(e),
                "text": f"[NmapScanner] Fallback response: {str(e)}"
            }
