"""
Modular Skill Component: EasyOCRReader
...
class EasyOCRReader:
    """Implementation of EasyOCRReader for intent: vision.ocr.easy"""

    def __init__(self, event_bus: Optional[Any] = None):
        self.event_bus = event_bus
        self.priority = 40
        self.supported_intent = "vision.ocr.easy"
        self.dependencies = []
    ...
    def handle(self, intent_data: Dict[str, Any], context: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "text": f"[EasyOCRReader] Successfully processed '{intent_data.get('intent')}'",
                "entities": entities
            }
            ...
            return {
                ...
                "skill": "EasyOCRReader",
                "error": str(e),
                "text": f"[EasyOCRReader] Fallback response: {str(e)}"
            }
