"""
Modular Skill Component: TesseractReader
Category: vision / Module: ocr
...
class TesseractReader:
    """Implementation of TesseractReader for intent: vision.ocr.tesseract"""

    def __init__(self, event_bus: Optional[Any] = None):
        self.event_bus = event_bus
        self.priority = 40
        self.supported_intent = "vision.ocr.tesseract"
        self.dependencies = []
    ...
    def handle(self, intent_data: Dict[str, Any], context: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "status": "success",
                "skill": "TesseractReader",
                "category": "vision",
                "handled_intent": intent_data.get("intent", self.supported_intent),
                "text": f"[TesseractReader] Successfully processed '{intent_data.get('intent')}'",
                "entities": entities
            }
            ...
            return {
                ...
                "skill": "TesseractReader",
                "error": str(e),
                "text": f"[TesseractReader] Fallback response: {str(e)}"
            }
