"""
Modular Skill Component: YagmailSender
Category: communication / Module: email
...
class YagmailSender:
    """Implementation of YagmailSender for intent: comm.email"""

    def __init__(self, event_bus: Optional[Any] = None):
        self.event_bus = event_bus
        self.priority = 30
        self.supported_intent = "comm.email"
        self.dependencies = []
    ...
    def handle(self, intent_data: Dict[str, Any], context: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "text": f"[YagmailSender] Successfully processed '{intent_data.get('intent')}'",
                "entities": entities
            }
            ...
            return {
                ...
                "skill": "YagmailSender",
                "error": str(e),
                "text": f"[YagmailSender] Fallback response: {str(e)}"
            }
