"""
Modular Skill Component: FileOperations
...
class FileOperations:
    """Implementation of FileOperations for intent: system.file.crud"""

    def __init__(self, event_bus: Optional[Any] = None):
        self.event_bus = event_bus
        self.priority = 20
        self.supported_intent = "system.file.crud"
        self.dependencies = []
    ...
    def handle(self, intent_data: Dict[str, Any], context: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "status": "success",
                "skill": "FileOperations",
                "category": "system_control",
                "handled_intent": intent_data.get("intent", self.supported_intent),
                "text": f"[FileOperations] Successfully processed '{intent_data.get('intent')}'",
                "entities": entities
            }
            ...
            return {
                ...
                "skill": "FileOperations",
                "error": str(e),
                "text": f"[FileOperations] Fallback response: {str(e)}"
            }
