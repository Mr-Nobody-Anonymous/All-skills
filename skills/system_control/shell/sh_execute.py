"""
Modular Skill Component: ShellExecutor
Category: system_control / Module: shell
...
class ShellExecutor:
    """Implementation of ShellExecutor for intent: system.shell"""

    def __init__(self, event_bus: Optional[Any] = None):
        self.event_bus = event_bus
        self.priority = 30
        self.supported_intent = "system.shell"
        self.dependencies = []
    ...
    def handle(self, intent_data: Dict[str, Any], context: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "text": f"[ShellExecutor] Successfully processed '{intent_data.get('intent')}'",
                "entities": entities
            }
            ...
            return {
                ...
                "skill": "ShellExecutor",
                "error": str(e),
                "text": f"[ShellExecutor] Fallback response: {str(e)}"
            }
