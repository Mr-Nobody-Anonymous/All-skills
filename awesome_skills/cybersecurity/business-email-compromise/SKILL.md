...
description: |
  Design BEC prevention and response procedures.
  TRIGGERS - Use when user needs help with business-email-compromise related tasks.
category: Cybersecurity
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/business-email-compromise/SKILL.md"
license: "MIT"
