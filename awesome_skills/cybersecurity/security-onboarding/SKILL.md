...
description: |
  Design security onboarding for new employees.
  TRIGGERS - Use when user needs help with security-onboarding related tasks.
category: Cybersecurity
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/security-onboarding/SKILL.md"
license: "MIT"
