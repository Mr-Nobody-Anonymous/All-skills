---
name: api-security-plan
description: |
  Design API security strategies and controls.
  TRIGGERS - Use when user needs help with api-security-plan related tasks.
category: Cybersecurity
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/api-security-plan/SKILL.md"
license: "MIT"
