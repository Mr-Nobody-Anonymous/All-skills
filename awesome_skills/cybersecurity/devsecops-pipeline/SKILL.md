...
description: |
  Design DevSecOps pipelines with security integration.
  TRIGGERS - Use when user needs help with devsecops-pipeline related tasks.
category: Cybersecurity
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/devsecops-pipeline/SKILL.md"
license: "MIT"
