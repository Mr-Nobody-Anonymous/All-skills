...
description: |
  Design security architectures for organizations.
  TRIGGERS - Use when user needs help with security-architecture related tasks.
category: Cybersecurity
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/security-architecture/SKILL.md"
license: "MIT"
