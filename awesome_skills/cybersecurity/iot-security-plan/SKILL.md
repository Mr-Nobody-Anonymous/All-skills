---
name: iot-security-plan
description: |
  Design IoT security plans with device management.
  TRIGGERS - Use when user needs help with iot-security-plan related tasks.
category: Cybersecurity
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/iot-security-plan/SKILL.md"
license: "MIT"
