---
name: mobile-security-plan
description: |
  Design mobile device security policies.
  TRIGGERS - Use when user needs help with mobile-security-plan related tasks.
category: Cybersecurity
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/mobile-security-plan/SKILL.md"
license: "MIT"
