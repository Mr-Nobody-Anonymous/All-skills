...
description: |
  Design browser security policies.
  TRIGGERS - Use when user needs help with browser-security-policy related tasks.
category: Cybersecurity
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/browser-security-policy/SKILL.md"
license: "MIT"
