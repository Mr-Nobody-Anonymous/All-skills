...
description: |
  Create mobile device security policies.
  TRIGGERS - Use when user needs help with mobile-security-policy related tasks.
category: Cybersecurity
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/mobile-security-policy/SKILL.md"
license: "MIT"
