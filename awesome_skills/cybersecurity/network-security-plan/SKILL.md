---
name: network-security-plan
description: |
  Design network security plans with firewalls and segmentation.
  TRIGGERS - Use when user needs help with network-security-plan related tasks.
category: Cybersecurity
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/network-security-plan/SKILL.md"
license: "MIT"
