...
description: |
  Conduct network security audits with testing.
  TRIGGERS - Use when user needs help with network-security-audit related tasks.
category: Cybersecurity
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/network-security-audit/SKILL.md"
license: "MIT"
