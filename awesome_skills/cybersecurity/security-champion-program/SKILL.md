...
description: |
  Build security champion programs.
  TRIGGERS - Use when user needs help with security-champion-program related tasks.
category: Cybersecurity
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/security-champion-program/SKILL.md"
license: "MIT"
