---
name: security-metrics-program
description: |
  Design security metrics programs.
  TRIGGERS - Use when user needs help with security-metrics-program related tasks.
category: Cybersecurity
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/security-metrics-program/SKILL.md"
license: "MIT"
