...
description: |
  Design phishing simulation campaigns for training.
  TRIGGERS - Use when user needs help with phishing-simulation related tasks.
category: Cybersecurity
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/phishing-simulation/SKILL.md"
license: "MIT"
