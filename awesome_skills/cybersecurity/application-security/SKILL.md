...
description: |
  Design application security programs with SAST/DAST.
  TRIGGERS - Use when user needs help with application-security related tasks.
category: Cybersecurity
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/application-security/SKILL.md"
license: "MIT"
