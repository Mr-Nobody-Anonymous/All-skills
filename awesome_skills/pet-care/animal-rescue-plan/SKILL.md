---
name: animal-rescue-plan
description: |
  Plan animal rescue operations.
  TRIGGERS - Use when user needs help with animal-rescue-plan related tasks.
category: Pet Care
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/animal-rescue-plan/SKILL.md"
license: "MIT"
