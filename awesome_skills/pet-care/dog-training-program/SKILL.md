---
name: dog-training-program
description: |
  Design dog training programs.
  TRIGGERS - Use when user needs help with dog-training-program related tasks.
category: Pet Care
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/dog-training-program/SKILL.md"
license: "MIT"
