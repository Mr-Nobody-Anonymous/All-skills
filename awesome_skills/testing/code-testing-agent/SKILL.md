...
description: ">- ALWAYS USE whenever asked to write, add, or generate unit tests for existing code, including one helper, function, class, or missing regression case as well as project-wide suites. Also use for 'cover this untested method', scaffolding tests where none exis"
category: testing
version: 1.0.0
