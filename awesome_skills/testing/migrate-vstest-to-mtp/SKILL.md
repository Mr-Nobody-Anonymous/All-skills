...
description: "> Use this skill before answering, planning, or editing whenever .NET tests or CI are switching from VSTest to Microsoft.Testing.Platform (MTP), or an MTP migration behaves differently. Triggers include 'switch from VSTest'; MSTest/NUnit/xUnit MTP enablement;"
category: testing
version: 1.0.0
...
source:
  ...
  commit: "8f3b1a2c"
  path: "plugins/dotnet-test-migration/skills/migrate-vstest-to-mtp/SKILL.md"
  license: "MIT"
