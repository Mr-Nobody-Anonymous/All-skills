...
description: "> Use this skill before answering or editing whenever an MSTest v1/v2 project is being upgraded or repaired for v3. Triggers include QualityTools assembly references; MSTest.TestFramework/TestAdapter 1.x-2.x; 'upgrade to MSTest v3'; comparing v1 and v2 migrati"
category: testing
version: 1.0.0
...
source:
  ...
  commit: "8f3b1a2c"
  path: "plugins/dotnet-test-migration/skills/migrate-mstest-v1v2-to-v3/SKILL.md"
  license: "MIT"
