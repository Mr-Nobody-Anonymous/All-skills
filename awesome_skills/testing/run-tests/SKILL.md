---
name: run-tests
description: ">- ALWAYS USE before running .NET tests or answering with a test command or flags. Trigger on 'run the tests', 'exact dotnet test command', one test/class/category/trait/target framework, combined filters, `--filter-query`, `--no-build`, `--diag`, diagnostic l"
category: testing
version: 1.0.0
...
source:
  ...
  commit: "8f3b1a2c"
  path: "plugins/dotnet-test/skills/run-tests/SKILL.md"
  license: "MIT"
