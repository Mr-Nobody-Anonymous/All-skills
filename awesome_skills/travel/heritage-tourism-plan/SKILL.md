---
name: heritage-tourism-plan
description: |
  Design heritage tourism programs with conservation.
  TRIGGERS - Use when user needs help with heritage-tourism-plan related tasks.
category: Travel
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/heritage-tourism-plan/SKILL.md"
license: "MIT"
