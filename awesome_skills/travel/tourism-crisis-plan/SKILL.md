---
name: tourism-crisis-plan
description: |
  Design tourism crisis management plans.
  TRIGGERS - Use when user needs help with tourism-crisis-plan related tasks.
category: Travel
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/tourism-crisis-plan/SKILL.md"
license: "MIT"
