---
name: airline-loyalty-program
description: |
  Design airline loyalty programs with tiers.
  TRIGGERS - Use when user needs help with airline-loyalty-program related tasks.
category: Travel
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/airline-loyalty-program/SKILL.md"
license: "MIT"
