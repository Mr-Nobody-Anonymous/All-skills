---
name: eco-tourism-plan
description: |
  Design eco-tourism programs with sustainability.
  TRIGGERS - Use when user needs help with eco-tourism-plan related tasks.
category: Travel
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/eco-tourism-plan/SKILL.md"
license: "MIT"
