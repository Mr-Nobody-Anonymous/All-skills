---
name: backpacking-guide
description: |
  Create backpacking guides with budget and routes.
  TRIGGERS - Use when user needs help with backpacking-guide related tasks.
category: Travel
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/backpacking-guide/SKILL.md"
license: "MIT"
