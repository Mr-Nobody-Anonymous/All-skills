...
description: |
  Create digital nomad guides with destinations and logistics.
  TRIGGERS - Use when user needs help with digital-nomad-guide related tasks.
category: Travel
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/digital-nomad-guide/SKILL.md"
license: "MIT"
