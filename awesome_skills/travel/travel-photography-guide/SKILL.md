...
description: |
  Create travel photography guides with composition.
  TRIGGERS - Use when user needs help with travel-photography-guide related tasks.
category: Travel
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/travel-photography-guide/SKILL.md"
license: "MIT"
