...
description: |
  Design hotel revenue management strategies.
  TRIGGERS - Use when user needs help with hotel-revenue-management related tasks.
category: Travel
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/hotel-revenue-management/SKILL.md"
license: "MIT"
