...
description: |
  Write engagement letter templates for accounting.
  TRIGGERS - Use when user needs help with engagement-letter related tasks.
category: Accounting
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/engagement-letter/SKILL.md"
license: "MIT"
