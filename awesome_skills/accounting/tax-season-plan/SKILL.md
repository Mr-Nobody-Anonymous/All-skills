---
name: tax-season-plan
description: |
  Plan tax season operations with staffing and deadlines.
  TRIGGERS - Use when user needs help with tax-season-plan related tasks.
category: Accounting
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/tax-season-plan/SKILL.md"
license: "MIT"
