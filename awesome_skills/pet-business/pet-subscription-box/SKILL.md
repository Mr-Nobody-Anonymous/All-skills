---
name: pet-subscription-box
description: |
  Plan pet subscription boxes.
  TRIGGERS - Use when user needs help with pet-subscription-box related tasks.
...
source_path: "skills/pet-subscription-box/SKILL.md"
license: "MIT"
