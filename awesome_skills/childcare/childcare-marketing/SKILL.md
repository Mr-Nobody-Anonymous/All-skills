---
name: childcare-marketing
description: |
  Create marketing plans for childcare centers.
  TRIGGERS - Use when user needs help with childcare-marketing related tasks.
category: Childcare
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/childcare-marketing/SKILL.md"
license: "MIT"
