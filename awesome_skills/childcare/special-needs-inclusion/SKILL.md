...
description: |
  Guide special needs inclusion in childcare.
  TRIGGERS - Use when user needs help with special-needs-inclusion related tasks.
category: Childcare
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/special-needs-inclusion/SKILL.md"
license: "MIT"
