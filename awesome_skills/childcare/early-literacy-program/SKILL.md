...
description: |
  Design early literacy programs for young children.
  TRIGGERS - Use when user needs help with early-literacy-program related tasks.
category: Childcare
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/early-literacy-program/SKILL.md"
license: "MIT"
