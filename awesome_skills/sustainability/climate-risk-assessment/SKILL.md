...
description: |
  Assess climate risks with scenario analysis.
  TRIGGERS - Use when user needs help with climate-risk-assessment related tasks.
category: Sustainability
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/climate-risk-assessment/SKILL.md"
license: "MIT"
