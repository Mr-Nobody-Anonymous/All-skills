...
description: |
  Design green procurement policies with criteria.
  TRIGGERS - Use when user needs help with green-procurement-policy related tasks.
category: Sustainability
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/green-procurement-policy/SKILL.md"
license: "MIT"
