...
description: |
  Design athletic training programs with periodization.
  TRIGGERS - Use when user needs help with training-program related tasks.
category: Sports & Fitness
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/training-program/SKILL.md"
license: "MIT"
