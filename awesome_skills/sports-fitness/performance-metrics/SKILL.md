...
description: |
  Design performance metrics for athlete tracking.
  TRIGGERS - Use when user needs help with performance-metrics related tasks.
category: Sports & Fitness
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/performance-metrics/SKILL.md"
license: "MIT"
