...
name: workout-plan
description: |
  Create workout plans with exercises and progression.
  TRIGGERS - Use when user needs help with workout-plan related tasks.
category: Sports & Fitness
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/workout-plan/SKILL.md"
license: "MIT"
