...
name: rehab-program
description: |
  Design rehabilitation programs with progression.
  TRIGGERS - Use when user needs help with rehab-program related tasks.
category: Sports & Fitness
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/rehab-program/SKILL.md"
license: "MIT"
