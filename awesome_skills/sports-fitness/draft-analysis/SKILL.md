...
name: draft-analysis
description: |
  Analyze draft prospects with comparisons and rankings.
  TRIGGERS - Use when user needs help with draft-analysis related tasks.
category: Sports & Fitness
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/draft-analysis/SKILL.md"
license: "MIT"
