---
name: sports-event-plan
description: |
  Plan sports events with logistics.
  TRIGGERS - Use when user needs help with sports-event-plan related tasks.
category: Sports & Fitness
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/sports-event-plan/SKILL.md"
license: "MIT"
