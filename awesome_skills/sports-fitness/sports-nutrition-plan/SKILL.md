...
description: |
  Design sports nutrition plans.
  TRIGGERS - Use when user needs help with sports-nutrition-plan related tasks.
category: Sports & Fitness
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/sports-nutrition-plan/SKILL.md"
license: "MIT"
