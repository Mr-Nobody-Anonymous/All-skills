---
name: salary-cap-analyzer
description: |
  Analyze salary cap situations with projections.
  TRIGGERS - Use when user needs help with salary-cap-analyzer related tasks.
category: Sports & Fitness
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/salary-cap-analyzer/SKILL.md"
license: "MIT"
