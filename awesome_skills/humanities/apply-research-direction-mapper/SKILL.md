---
name: apply-research-direction-mapper
...
source_path: "skills/academic-career/apply-research-direction-mapper/SKILL.md"
license: "MIT"
...
- The user is choosing entire programs or building a school shortlist. Use `apply-program-fit-mapper`.
- The user wants the actual cold email draft. Use `apply-cold-email-drafter` after the direction is mapped.
- The user wants polished SOP prose. Use `apply-sop-writer`.
...
Hand off to `apply-cold-email-drafter` for the actual message.
