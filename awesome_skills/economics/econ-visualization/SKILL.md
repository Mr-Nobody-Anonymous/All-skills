...
description: "> Generates publication-quality economics figures produced by code (R `ggplot2`, Python `matplotlib`/`seaborn`, Stata `twoway`/`coefplot`) and exported in vector format directly to the paper's `figs/` folder. Defaults to DIME's 'full replicability' tier and the [Reviewing Graphs checklist](https://d"
category: economics
version: 1.0.0
...
source_path: "_skills/communication/econ-visualization/SKILL.md"
license: "MIT"
