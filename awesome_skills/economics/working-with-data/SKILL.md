...
description: "> Foundational data-discipline skill for econometrics work in any language. Enforces the discipline that every other data, analysis, and writing skill depends on: define the unit of analysis before anything else; treat IDs as a contract; merge with explicit cardinality and validation; never silently"
category: economics
version: 1.0.0
disable-model-invocation: false
risk: low
source: "https://github.com/JonasWeinert/EconAgentSkills"
source_repository: "JonasWeinert/EconAgentSkills"
source_path: "_skills/data/working-with-data/SKILL.md"
license: "MIT"
