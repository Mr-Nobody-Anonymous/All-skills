...
description: "> Drafts and revises empirical and theoretical economics papers in journal-style structure (introduction, literature, data, identification, results, robustness, discussion, conclusion), with explicit identification arguments, careful causal language, and reviewer-response discipline. Cross-links to"
category: economics
version: 1.0.0
...
source_path: "_skills/writing/academic-paper-writer/SKILL.md"
license: "MIT"
