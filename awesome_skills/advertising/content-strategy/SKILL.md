...
description: >
  Use this skill when planning a content strategy or deciding what content to create. Trigger phrases include: "build a content strategy," "plan our content," "create a content calendar," "what content should we create," "map our content to the funnel," "build topic clusters," "define our content pillars," "plan our editorial calendar," "how do we distribute content," "measure content ROI," or "what content drives leads." This skill covers topic cluster methodology, content pillars, keyword-to-content mapping, editorial calendar building, content formats by funnel stage, distribution strategy, and measuring content ROI. Distinct from writing individual content pieces.
source: "https://github.com/scayver/marketing-skills"
source_repository: "scayver/marketing-skills"
source_path: "skills/content-strategy/SKILL.md"
license: "MIT"
...
1. The product and the primary audience (who they are and what they care about)
2. The business goal for content (pipeline, SEO, retention, brand)
3. Current publishing capacity and team size
4. Whether a content archive exists and roughly what it contains
5. Any existing keyword research, analytics data, or audience research
6. The primary distribution channels already in use
7. Whether you need a full strategy document, a topic cluster map, an editorial calendar, or all three
