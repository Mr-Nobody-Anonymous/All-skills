...
name: ai-seo
description: >
  Use this skill when optimizing content to appear in AI-generated answers, be cited by LLMs, or rank in AI search engines. Trigger phrases: "AI SEO," "AEO," "GEO," "LLMO," "appear in ChatGPT," "cited by Perplexity," "AI Overviews," "optimize for AI search," "generative engine optimization," "answer engine optimization," "get cited by AI," "LLM citation," "AI search visibility."
source: "https://github.com/scayver/marketing-skills"
source_repository: "scayver/marketing-skills"
source_path: "skills/ai-seo/SKILL.md"
license: "MIT"
...
Identify the 20 to 30 most important questions your target audience asks in your category. Enter each question into ChatGPT (with browsing), Perplexity, Claude, Gemini, and Google's AI Overviews. Record whether your brand, your content, or your URL is cited in the response.

Do this monthly. Track your citation rate across queries over time. A citation rate of 30% in month one improving to 55% in month six is a meaningful signal that your optimization is working.

This is manual and time-consuming, but it is currently the most reliable method. Tools like Brandwatch, Semrush (which added AI visibility features), and specialized AI visibility trackers (TrustRadius, Profound) are adding features to automate this monitoring.

### Brand Mention Monitoring in AI Responses

Monitor how AI systems describe your brand when asked about your category. Ask Perplexity and ChatGPT "what are the best tools for [your category]?" and "who are the leading companies in [your space]?" regularly.

Document how your brand is described. Are the facts accurate? Is the positioning aligned with how you want to be known? Are there missing proof points that should be included?

If AI systems consistently describe a competitor as "the most popular" or "the highest-rated" option, investigate what signals are creating that perception and whether there are accurate counter-claims you should be making more prominently in your content and external coverage.

### Tracking Direct Traffic from AI Sources

Some users who find your brand through AI search will visit your website. Perplexity sends referral traffic that shows up in GA4 as perplexity.ai. ChatGPT's browsing mode sends traffic from chatgpt.com/chat. Track these sources in your analytics.

Create a segment in GA4 for AI-originated sessions. Monitor traffic volume, conversion rates, and behavior patterns. AI-referred users often exhibit high engagement because they arrived after a research process rather than from a cold search.

---

## Content Formats That Get Cited

Certain content formats consistently earn more AI citations than others.

Original research and data: if your company publishes a survey, study, or dataset, that data becomes a citable source. A staffing company that surveys 1,000 remote workers about their work habits generates a data asset that AI systems can cite across thousands of related queries.

Definitive guides: comprehensive, current, well-structured guides on specific topics become reference sources. If your guide on "how to structure a freelance contract" covers the topic more thoroughly than any other source, AI systems will cite it repeatedly.

Comparison pages: "X vs. Y" content and category comparison pages are heavily cited because users frequently ask AI systems to compare options. Maintain accurate, fair comparison pages that cover your product against alternatives.

Glossary and definition content: well-written definitions for industry terms become persistent citation sources because AI systems regularly explain terminology to users.

FAQ content: explicit FAQ sections with question-and-answer structure are well-suited for AI extraction. Add an FAQ section to every important page.

---

## Building an AI SEO Content Roadmap

Approach AI SEO as a content and authority-building program, not a one-time optimization.

Month one: audit your existing content. Identify your 20 most important topic areas. For each, ask whether you have a comprehensive, well-structured page that directly answers the core question. If not, that is a content gap.

Month two: conduct a citation audit. For each of your 20 topic areas, run the core question through Perplexity, ChatGPT, and Google AI Overviews. Record who is cited. Analyze why. What does the cited content have that yours does not?

Month three: update and improve existing content. Add statistics, question-based headers, FAQ sections, and direct answers at the top of sections. These structural improvements can be applied to existing pages without full rewrites.

Month four onward: build new content to close topic gaps. Commission original research. Develop comprehensive guides. Build out topical clusters in your highest-priority areas.

Throughout: build external authority. Pitch journalists and editors in your vertical. Submit data and expertise to roundup articles. Seek citations in industry publications. Every external citation strengthens your entity authority with AI systems.

This program compounds over time. A brand with consistent, well-structured content and strong external citations in six months will have substantially better AI search visibility than it does today.
