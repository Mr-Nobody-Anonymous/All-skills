...
description: "Dynamic IP Routing & Interior/Exterior Gateways: Border Gateway Protocol (BGP-4), Open Shortest Path First (OSPF v2/v3), IS-IS, route redistribution, Autonomous System (AS) path attributes, and CIDR prefix aggregation."
...
# Dynamic IP Routing & Interior/Exterior Gateways

Border Gateway Protocol (BGP-4), Open Shortest Path First (OSPF v2/v3), IS-IS, route redistribution, Autonomous System (AS) path attributes, and CIDR prefix aggregation.

## Standard Operating Procedure & Methodology

### 1. Conceptual & Theoretical Foundations
Formulate the theoretical principles governing dynamic ip routing & interior/exterior gateways:
