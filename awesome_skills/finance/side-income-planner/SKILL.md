---
name: side-income-planner
description: |
  Plan side income streams.
  TRIGGERS - Use when user needs help with side-income-planner related tasks.
category: Personal Finance
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/side-income-planner/SKILL.md"
license: "MIT"
