...
description: |
  Design guest booking strategies.
  TRIGGERS - Use when user needs help with podcast-guest-strategy related tasks.
category: Podcast
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/podcast-guest-strategy/SKILL.md"
license: "MIT"
