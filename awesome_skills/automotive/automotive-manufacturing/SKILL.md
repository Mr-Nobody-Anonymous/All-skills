...
description: >
  Expert skill in additive manufacturing for automotive tooling, rapid prototyping, metal sintering, and production part fabrication. Covers 40 topics across manufacturing domain. Includes 40 skill files covering AIAG APQP (Advanced Product Quality Planning), AIAG CQI-19 - Sub-Tier Supplier Management, AIAG Core Tools (FMEA, Control Plan, MSA), AIAG MMOG/LE Materials Management Logistics Evaluation, AIAG MSA (Measurement Systems Analysis), AIAG MSA - Measurement Systems Analysis for AI Systems, AIAG MSA - Measurement Systems Analysis for Vision Systems, AIAG PPAP (Production Part Approval Process) and more.
tags: [3d-printing, 5s, abb, additive-manufacturing, adhesive, agv, aluminum, amr, assembly-line, augmented-reality, automotive, automotive-manufacturing, battery, battery-pack, body-shop, carbon-neutral, cell-to-pack, cobot, cobots, collaborative-robots, condition-monitoring, cpk, ctc, ctp, cyber-physical, deep-learning, digital-thread, digital-twin, e-coat, edge-ai, edge-computing, energy-management, energy-recovery, eobt, ev, ev-manufacturing, factory-optimization, fanuc, final-assembly, fleet-coordination, genealogy, giga-press, historian, hmi, hpdc, human-robot-collaboration, iatf-16949, iec-61131-3, industry-4-0, industry-5-0, inference, inspection, isa-101, isa-95, isaac-sim, iso-ts-15066, just-in-time, kaizen, kanban, kuka, ladder-logic, laser-welding, lean, lean-manufacturing, line-balancing, logistics, machine-learning, machine-vision, manufacturing, marriage-station, megacasting, mes, metal-am, metaverse, navigation, near-shoring, nvidia-jetson, nvidia-omniverse, oee, opc-ua, paint-shop, plc, predictive-analytics, predictive-maintenance, production-tracking, quality, quality-control, renewable-energy, robotic-painting, robotics, rsw, safety, scada, serialization, shop-floor, simulation, slam, sourcing-strategy, spc, structural-battery, supply-chain, sustainability, swarm-robotics, takt-time, thermal, thermal-management, topology-optimization, torque, traceability, value-stream-mapping, vda-5050, vibration-analysis, virtual-reality, voc, waste-to-energy, welding, zero-defect, zero-waste]
...
source_path: "skills/automotive-manufacturing/SKILL.md"
license: "MIT"
