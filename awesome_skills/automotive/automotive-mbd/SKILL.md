...
name: automotive-mbd
description: >
  Expert skill in ascet focusing on mbd domain applications. Covers 166 topics across mbd domain. Includes 166 skill files covering ASPICE Level 3, AUTOSAR 4.4, ISO 21434, ISO 26262.
tags: [asap2, ascet, asil-d, automotive, automotive-mbd, autosar, calibration, certification, co-simulation, code-generation, do-178c, dspace, electric-vehicle, embedded-coder, fixed-point, fmi, fmu, formal-verification, integration, interoperability, iso-26262, jmaab, maab, mbd, metrics, misra-c, model-advisor, model-exchange, model-validation, model-verification, modelica, multi-domain, openmodelica, opensource, physical-modeling, production-code, qualified-code, quality, rapid-prototyping, real-time, safety-critical, scade, simulation, simulink, simulink-modeling, stateflow, targetlink, testing, traceability, validation, verification]
...
source_path: "skills/automotive-mbd/SKILL.md"
license: "MIT"
