...
description: |
  Design DeFi lending protocols.
  TRIGGERS - Use when user needs help with defi-lending-protocol related tasks.
category: Crypto & Blockchain
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/defi-lending-protocol/SKILL.md"
license: "MIT"
