---
name: exchange-listing-plan
description: |
  Plan exchange listing strategies for tokens.
  TRIGGERS - Use when user needs help with exchange-listing-plan related tasks.
category: Crypto & Blockchain
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/exchange-listing-plan/SKILL.md"
license: "MIT"
