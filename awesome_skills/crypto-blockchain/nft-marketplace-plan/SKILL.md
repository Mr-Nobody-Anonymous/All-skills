---
name: nft-marketplace-plan
description: |
  Plan NFT marketplace development.
  TRIGGERS - Use when user needs help with nft-marketplace-plan related tasks.
category: Crypto & Blockchain
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/nft-marketplace-plan/SKILL.md"
license: "MIT"
