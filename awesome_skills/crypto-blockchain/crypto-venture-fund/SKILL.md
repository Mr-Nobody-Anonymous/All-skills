---
name: crypto-venture-fund
description: |
  Design crypto venture fund strategies.
  TRIGGERS - Use when user needs help with crypto-venture-fund related tasks.
category: Crypto & Blockchain
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/crypto-venture-fund/SKILL.md"
license: "MIT"
