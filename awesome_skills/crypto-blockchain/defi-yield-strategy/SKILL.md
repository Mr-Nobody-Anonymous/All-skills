...
description: |
  Design DeFi yield optimization strategies.
  TRIGGERS - Use when user needs help with defi-yield-strategy related tasks.
category: Crypto & Blockchain
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/defi-yield-strategy/SKILL.md"
license: "MIT"
