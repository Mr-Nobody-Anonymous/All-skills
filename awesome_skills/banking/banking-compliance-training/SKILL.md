...
description: |
  Design banking compliance training.
  TRIGGERS - Use when user needs help with banking-compliance-training related tasks.
category: Banking
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/banking-compliance-training/SKILL.md"
license: "MIT"
