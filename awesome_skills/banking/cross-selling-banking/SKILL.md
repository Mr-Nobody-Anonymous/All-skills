---
name: cross-selling-banking
description: |
  Create cross-selling strategies for banking products.
  TRIGGERS - Use when user needs help with cross-selling-banking related tasks.
category: Banking
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/cross-selling-banking/SKILL.md"
license: "MIT"
