...
description: |
  Design fintech partnership evaluation and integration.
  TRIGGERS - Use when user needs help with fintech-partnership related tasks.
category: Banking
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/fintech-partnership/SKILL.md"
license: "MIT"
