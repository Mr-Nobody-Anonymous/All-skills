...
description: |
  Design regulatory reporting processes and systems.
  TRIGGERS - Use when user needs help with regulatory-reporting related tasks.
category: Banking
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/regulatory-reporting/SKILL.md"
license: "MIT"
