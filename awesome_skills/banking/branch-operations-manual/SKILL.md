---
name: branch-operations-manual
description: |
  Create bank branch operations manuals.
  TRIGGERS - Use when user needs help with branch-operations-manual related tasks.
category: Banking
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/branch-operations-manual/SKILL.md"
license: "MIT"
