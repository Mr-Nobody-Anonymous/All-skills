...
description: |
  Design digital account opening flows.
  TRIGGERS - Use when user needs help with digital-account-opening related tasks.
category: Banking
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/digital-account-opening/SKILL.md"
license: "MIT"
