...
description: |
  Design AML compliance programs with monitoring.
  TRIGGERS - Use when user needs help with anti-money-laundering related tasks.
category: Banking
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/anti-money-laundering/SKILL.md"
license: "MIT"
