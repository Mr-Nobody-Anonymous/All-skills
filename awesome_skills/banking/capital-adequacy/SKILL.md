...
description: |
  Assess capital adequacy with regulatory requirements.
  TRIGGERS - Use when user needs help with capital-adequacy related tasks.
category: Banking
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/capital-adequacy/SKILL.md"
license: "MIT"
