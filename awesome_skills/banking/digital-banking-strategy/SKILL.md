...
description: |
  Create digital banking transformation strategies.
  TRIGGERS - Use when user needs help with digital-banking-strategy related tasks.
category: Banking
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/digital-banking-strategy/SKILL.md"
license: "MIT"
