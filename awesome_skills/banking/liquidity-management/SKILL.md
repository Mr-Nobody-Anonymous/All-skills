...
description: |
  Design liquidity management frameworks for banks.
  TRIGGERS - Use when user needs help with liquidity-management related tasks.
category: Banking
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/liquidity-management/SKILL.md"
license: "MIT"
