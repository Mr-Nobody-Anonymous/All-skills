...
description: |
  Design financial crime prevention programs.
  TRIGGERS - Use when user needs help with financial-crime-prevention related tasks.
category: Banking
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/financial-crime-prevention/SKILL.md"
license: "MIT"
