...
name: trade-finance
description: |
  Design trade finance products with documentation.
  TRIGGERS - Use when user needs help with trade-finance related tasks.
category: Banking
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/trade-finance/SKILL.md"
license: "MIT"
