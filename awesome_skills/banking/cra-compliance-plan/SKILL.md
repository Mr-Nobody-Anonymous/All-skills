---
name: cra-compliance-plan
description: |
  Design CRA compliance plans.
  TRIGGERS - Use when user needs help with cra-compliance-plan related tasks.
category: Banking
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/cra-compliance-plan/SKILL.md"
license: "MIT"
