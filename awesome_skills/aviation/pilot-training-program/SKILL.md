...
description: |
  Design pilot training programs with curriculum.
  TRIGGERS - Use when user needs help with pilot-training-program related tasks.
category: Aviation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/pilot-training-program/SKILL.md"
license: "MIT"
