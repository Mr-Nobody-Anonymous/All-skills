---
name: aviation-safety-plan
description: |
  Design aviation safety management systems.
  TRIGGERS - Use when user needs help with aviation-safety-plan related tasks.
category: Aviation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/aviation-safety-plan/SKILL.md"
license: "MIT"
