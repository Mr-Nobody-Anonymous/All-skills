---
name: drone-operations-manual
description: |
  Create drone operations manuals with FAA compliance.
  TRIGGERS - Use when user needs help with drone-operations-manual related tasks.
category: Aviation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/drone-operations-manual/SKILL.md"
license: "MIT"
