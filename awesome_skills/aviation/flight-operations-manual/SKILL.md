...
description: |
  Create flight operations manuals with procedures.
  TRIGGERS - Use when user needs help with flight-operations-manual related tasks.
category: Aviation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/flight-operations-manual/SKILL.md"
license: "MIT"
