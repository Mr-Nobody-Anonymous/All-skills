...
description: |
  Design aviation sustainability programs.
  TRIGGERS - Use when user needs help with aviation-sustainability related tasks.
category: Aviation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/aviation-sustainability/SKILL.md"
license: "MIT"
