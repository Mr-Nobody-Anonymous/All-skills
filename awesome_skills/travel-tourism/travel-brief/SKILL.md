---
name: travel-brief
description: "Turn flight and hotel search results into a client-ready travel brief - a one-line recommendation first, then a markdown comparison table, the low|typical|high verdict read from price_range_in_relation_to_other_periods against the price_insights_low/price_insights_high band, the buy_link and hotel b"
category: travel-tourism
version: 1.0.0
disable-model-invocation: false
risk: low
source: "https://github.com/mtnrabi/travel-agent-skills"
source_repository: "mtnrabi/travel-agent-skills"
source_path: "skills/travel-brief/SKILL.md"
license: "MIT"
