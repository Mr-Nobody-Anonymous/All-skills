...
description: |
  Design nonprofit social media strategies.
  TRIGGERS - Use when user needs help with nonprofit-social-media related tasks.
category: Nonprofit
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/nonprofit-social-media/SKILL.md"
license: "MIT"
