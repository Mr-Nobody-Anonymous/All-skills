...
description: |
  Create donor recognition programs with tiers.
  TRIGGERS - Use when user needs help with donor-recognition related tasks.
category: Nonprofit
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/donor-recognition/SKILL.md"
license: "MIT"
