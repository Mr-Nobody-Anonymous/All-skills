...
description: |
  Design program evaluation frameworks with metrics.
  TRIGGERS - Use when user needs help with program-evaluation related tasks.
category: Nonprofit
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/program-evaluation/SKILL.md"
license: "MIT"
