---
name: planned-giving-program
description: |
  Design planned giving programs.
  TRIGGERS - Use when user needs help with planned-giving-program related tasks.
category: Nonprofit
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/planned-giving-program/SKILL.md"
license: "MIT"
