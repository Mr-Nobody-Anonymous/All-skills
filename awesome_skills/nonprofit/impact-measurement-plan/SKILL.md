...
description: |
  Design impact measurement systems.
  TRIGGERS - Use when user needs help with impact-measurement-plan related tasks.
category: Nonprofit
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/impact-measurement-plan/SKILL.md"
license: "MIT"
