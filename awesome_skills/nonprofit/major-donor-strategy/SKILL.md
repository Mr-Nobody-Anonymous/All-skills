---
name: major-donor-strategy
description: |
  Design major donor cultivation strategies.
  TRIGGERS - Use when user needs help with major-donor-strategy related tasks.
category: Nonprofit
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/major-donor-strategy/SKILL.md"
license: "MIT"
