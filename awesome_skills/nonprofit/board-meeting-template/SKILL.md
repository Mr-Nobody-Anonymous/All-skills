...
description: |
  Create board meeting templates.
  TRIGGERS - Use when user needs help with board-meeting-template related tasks.
category: Nonprofit
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/board-meeting-template/SKILL.md"
license: "MIT"
