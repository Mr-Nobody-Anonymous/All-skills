...
description: |
  Create volunteer management systems and procedures.
  TRIGGERS - Use when user needs help with volunteer-management related tasks.
category: Nonprofit
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/volunteer-management/SKILL.md"
license: "MIT"
