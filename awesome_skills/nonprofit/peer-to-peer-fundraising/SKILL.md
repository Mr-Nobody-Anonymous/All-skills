...
description: |
  Design peer-to-peer fundraising campaigns.
  TRIGGERS - Use when user needs help with peer-to-peer-fundraising related tasks.
category: Nonprofit
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/peer-to-peer-fundraising/SKILL.md"
license: "MIT"
