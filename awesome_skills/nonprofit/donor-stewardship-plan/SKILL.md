---
name: donor-stewardship-plan
description: |
  Design donor stewardship programs.
  TRIGGERS - Use when user needs help with donor-stewardship-plan related tasks.
category: Nonprofit
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/donor-stewardship-plan/SKILL.md"
license: "MIT"
