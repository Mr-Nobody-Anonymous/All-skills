...
description: "High-risk Polymarket trading operations — configure wallet-backed CLOB access, place limit/market orders, cancel orders, and view account-specific orders/trades. Requires py-clob-client-v2 and a user-controlled wallet. Use only when the user explicitly asks to trade or manage orders in the current s"
category: sports
version: 1.0.0
...
source_path: "skills/polymarket-trading/SKILL.md"
license: "MIT"
