...
description: "Generates original sports journalism articles by consuming real-time data from the sports-skills skills. Covers game previews, live reports, post-game, team analysis, and player profiles for all supported sports. Use when: the user asks to write, generate, create, or draft an article, preview, repor"
category: sports
version: 1.0.0
...
source_path: "skills/sports-reporter/SKILL.md"
license: "MIT"
