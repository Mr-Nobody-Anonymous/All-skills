---
name: football-data
description: "Football (soccer) data across the world's major leagues — standings, schedules, match stats, xG, transfers, player profiles, head-to-head history, team strength (Elo), and match forecasts. Zero config, no API keys. Covers Premier League, La Liga, Bundesliga, Serie A, Ligue 1, MLS, Champions League,"
category: sports
version: 1.0.0
...
source_path: "skills/football-data/SKILL.md"
license: "MIT"
