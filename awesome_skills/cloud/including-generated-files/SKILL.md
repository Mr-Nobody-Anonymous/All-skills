...
description: "'Fix MSBuild targets that generate files during the build but those files are missing from compilation or output. USE FOR: generated source files not compiling (CS0246 for a type that should exist), custom build tasks that create files but they are invisible t"
category: cloud
version: 1.0.0
...
source:
  ...
  commit: "8f3b1a2c"
  path: "plugins/dotnet-msbuild/skills/including-generated-files/SKILL.md"
  license: "MIT"
