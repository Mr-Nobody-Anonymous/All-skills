---
name: convert-to-cpm
description: "> Convert .NET projects and solutions (.sln, .slnx) to NuGet Central Package Management (CPM) using Directory.Packages.props. USE FOR: converting to CPM, centralizing or aligning NuGet package versions across multiple projects, inlining MSBuild version propert"
category: cloud
version: 1.0.0
...
source:
  ...
  commit: "8f3b1a2c"
  path: "plugins/dotnet-nuget/skills/convert-to-cpm/SKILL.md"
  license: "MIT"
