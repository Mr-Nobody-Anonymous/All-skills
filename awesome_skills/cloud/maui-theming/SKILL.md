---
name: maui-theming
description: ">- Guide for theming .NET MAUI apps — light/dark mode via AppThemeBinding, ResourceDictionary theme switching, DynamicResource bindings, system theme detection, and user theme preferences. Use when: 'dark mode', 'light mode', 'theming', 'AppThemeBinding', 'the"
category: cloud
version: 1.0.0
