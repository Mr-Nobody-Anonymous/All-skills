...
description: ">- Identify a .NET project's test platform, framework, command mode, and SDK-style vs classic project system. Use only for 'which test platform/framework?', 'VSTest or MTP?', or 'what runner does this project use?', including bridge settings, UseVSTest opt-out"
category: cloud
version: 1.0.0
