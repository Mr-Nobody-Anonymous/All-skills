...
description: "Guide developers through capturing diagnostic artifacts to diagnose production .NET performance issues. Use when the user needs help choosing diagnostic tools, collecting performance data, or understanding tool trade-offs across different environments (Windows"
category: cloud
version: 1.0.0
...
source:
  ...
  commit: "8f3b1a2c"
  path: "plugins/dotnet-diag/skills/dotnet-trace-collect/SKILL.md"
  license: "MIT"
