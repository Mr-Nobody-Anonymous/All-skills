---
name: mtp-hot-reload
description: "> Set up or recover MTP hot reload for a long-lived console-host edit/re-run loop in a Microsoft Testing Platform project. Use for explicit MTP console requests such as 'enable hot reload', 'dotnet run to rerun on edit', or unsupported/rude edits. Covers setup"
category: cloud
version: 1.0.0
...
source:
  ...
  commit: "8f3b1a2c"
  path: "plugins/dotnet-test/skills/mtp-hot-reload/SKILL.md"
  license: "MIT"
