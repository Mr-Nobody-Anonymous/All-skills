...
description: |
  Create angel investor pitches.
  TRIGGERS - Use when user needs help with angel-investor-pitch related tasks.
category: Startup
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/angel-investor-pitch/SKILL.md"
license: "MIT"
