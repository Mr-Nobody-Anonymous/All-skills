...
description: |
  Write incubator applications.
  TRIGGERS - Use when user needs help with incubator-application related tasks.
category: Startup
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/incubator-application/SKILL.md"
license: "MIT"
