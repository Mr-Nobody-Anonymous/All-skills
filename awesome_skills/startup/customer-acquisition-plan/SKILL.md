...
description: |
  Plan customer acquisition strategies.
  TRIGGERS - Use when user needs help with customer-acquisition-plan related tasks.
category: Startup
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/customer-acquisition-plan/SKILL.md"
license: "MIT"
