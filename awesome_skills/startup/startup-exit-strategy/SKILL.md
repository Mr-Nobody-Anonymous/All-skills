---
name: startup-exit-strategy
description: |
  Design startup exit strategies.
  TRIGGERS - Use when user needs help with startup-exit-strategy related tasks.
category: Startup
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/startup-exit-strategy/SKILL.md"
license: "MIT"
