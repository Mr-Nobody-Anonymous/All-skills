...
description: |
  Create founder sales playbooks.
  TRIGGERS - Use when user needs help with founder-sales-playbook related tasks.
category: Startup
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/founder-sales-playbook/SKILL.md"
license: "MIT"
