...
description: |
  Create startup marketing plans.
  TRIGGERS - Use when user needs help with startup-marketing-plan related tasks.
category: Startup
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/startup-marketing-plan/SKILL.md"
license: "MIT"
