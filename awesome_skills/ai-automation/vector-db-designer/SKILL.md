...
description: |
  Design vector database architectures for AI search and retrieval.
  TRIGGERS - Use when user needs help with vector-db-designer related tasks.
category: AI & Automation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/vector-db-designer/SKILL.md"
license: "MIT"
