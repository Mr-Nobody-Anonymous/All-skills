...
description: |
  Build AI fallback systems with model routing.
  TRIGGERS - Use when user needs help with ai-fallback-system related tasks.
category: AI & Automation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/ai-fallback-system/SKILL.md"
license: "MIT"
