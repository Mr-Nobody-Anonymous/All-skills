...
description: |
  Design AI evaluation frameworks with benchmarks.
  TRIGGERS - Use when user needs help with ai-eval-framework related tasks.
category: AI & Automation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/ai-eval-framework/SKILL.md"
license: "MIT"
