...
description: |
  Design sentiment analysis systems for reviews and social media.
  TRIGGERS - Use when user needs help with ai-sentiment-analyzer related tasks.
category: AI & Automation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/ai-sentiment-analyzer/SKILL.md"
license: "MIT"
