...
description: |
  Design recommendation engines with collaborative and content-based filtering.
  TRIGGERS - Use when user needs help with ai-recommendation-engine related tasks.
category: AI & Automation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/ai-recommendation-engine/SKILL.md"
license: "MIT"
