...
description: |
  Calculate ROI for AI initiatives with cost modeling and benefit quantification.
  TRIGGERS - Use when user needs help with ai-roi-calculator related tasks.
category: AI & Automation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/ai-roi-calculator/SKILL.md"
license: "MIT"
