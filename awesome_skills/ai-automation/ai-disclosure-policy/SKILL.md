...
description: |
  Write AI disclosure policies for transparency with customers and stakeholders.
  TRIGGERS - Use when user needs help with ai-disclosure-policy related tasks.
category: AI & Automation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/ai-disclosure-policy/SKILL.md"
license: "MIT"
