...
description: |
  Build AI-powered search engines with ranking.
  TRIGGERS - Use when user needs help with ai-search-engine related tasks.
category: AI & Automation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/ai-search-engine/SKILL.md"
license: "MIT"
