---
name: ai-model-card-writer
description: |
  Write model cards documenting AI capabilities.
  TRIGGERS - Use when user needs help with ai-model-card-writer related tasks.
category: AI & Automation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/ai-model-card-writer/SKILL.md"
license: "MIT"
imported_at: "2026-09-20"
---
# ai-model-card-writer
## Workflow
