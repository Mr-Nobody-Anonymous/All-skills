...
description: |
  Design escalation matrices with severity levels and contacts.
  TRIGGERS - Use when user needs help with escalation-matrix related tasks.
category: AI & Automation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/escalation-matrix/SKILL.md"
license: "MIT"
