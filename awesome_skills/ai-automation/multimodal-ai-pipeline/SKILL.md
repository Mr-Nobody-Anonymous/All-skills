...
description: |
  Build multimodal AI pipelines with text, image, audio.
  TRIGGERS - Use when user needs help with multimodal-ai-pipeline related tasks.
category: AI & Automation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/multimodal-ai-pipeline/SKILL.md"
license: "MIT"
