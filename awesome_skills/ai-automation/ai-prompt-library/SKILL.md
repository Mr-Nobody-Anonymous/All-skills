...
description: |
  Build organized prompt libraries with categories, versions, and performance tracking.
  TRIGGERS - Use when user needs help with ai-prompt-library related tasks.
category: AI & Automation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/ai-prompt-library/SKILL.md"
license: "MIT"
