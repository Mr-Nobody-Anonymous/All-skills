...
description: |
  Build feedback collection for AI outputs.
  TRIGGERS - Use when user needs help with ai-feedback-collector related tasks.
category: AI & Automation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/ai-feedback-collector/SKILL.md"
license: "MIT"
