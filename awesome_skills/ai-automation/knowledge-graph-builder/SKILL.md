...
description: |
  Design knowledge graphs for structured information retrieval.
  TRIGGERS - Use when user needs help with knowledge-graph-builder related tasks.
category: AI & Automation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/knowledge-graph-builder/SKILL.md"
license: "MIT"
