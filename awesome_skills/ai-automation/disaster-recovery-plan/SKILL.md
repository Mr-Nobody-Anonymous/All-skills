...
description: |
  Create disaster recovery plans with RTO, RPO, and failover.
  TRIGGERS - Use when user needs help with disaster-recovery-plan related tasks.
category: AI & Automation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/disaster-recovery-plan/SKILL.md"
license: "MIT"
