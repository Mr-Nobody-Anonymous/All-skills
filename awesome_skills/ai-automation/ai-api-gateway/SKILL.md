...
name: ai-api-gateway
description: |
  Design AI API gateways with rate limiting and routing.
  TRIGGERS - Use when user needs help with ai-api-gateway related tasks.
category: AI & Automation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/ai-api-gateway/SKILL.md"
license: "MIT"
