...
name: rpa-designer
description: |
  Design RPA solutions with bot workflows and exception handling.
  TRIGGERS - Use when user needs help with rpa-designer related tasks.
category: AI & Automation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/rpa-designer/SKILL.md"
license: "MIT"
