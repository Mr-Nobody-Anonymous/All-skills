...
description: |
  Design AI personalization engines for content.
  TRIGGERS - Use when user needs help with ai-personalization-engine related tasks.
category: AI & Automation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/ai-personalization-engine/SKILL.md"
license: "MIT"
