...
description: |
  Create AI safety checklists for deployment readiness and risk mitigation.
  TRIGGERS - Use when user needs help with ai-safety-checklist related tasks.
category: AI & Automation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/ai-safety-checklist/SKILL.md"
license: "MIT"
