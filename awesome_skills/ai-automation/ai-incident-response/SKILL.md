...
description: |
  Design incident response for AI system failures.
  TRIGGERS - Use when user needs help with ai-incident-response related tasks.
category: AI & Automation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/ai-incident-response/SKILL.md"
license: "MIT"
