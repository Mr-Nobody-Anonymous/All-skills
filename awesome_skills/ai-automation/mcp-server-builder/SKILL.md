...
description: |
  Build MCP servers for AI tool integration.
  TRIGGERS - Use when user needs help with mcp-server-builder related tasks.
category: AI & Automation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/mcp-server-builder/SKILL.md"
license: "MIT"
