...
description: |
  Optimize workflows for speed, cost, and error reduction.
  TRIGGERS - Use when user needs help with workflow-optimizer related tasks.
category: AI & Automation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/workflow-optimizer/SKILL.md"
license: "MIT"
