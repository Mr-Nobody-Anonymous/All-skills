...
description: |
  Create evaluation frameworks for AI outputs with rubrics and scoring.
  TRIGGERS - Use when user needs help with ai-evaluation-framework related tasks.
category: AI & Automation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/ai-evaluation-framework/SKILL.md"
license: "MIT"
