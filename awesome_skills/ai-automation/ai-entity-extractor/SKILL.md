...
description: |
  Build entity extraction systems for structured data from text.
  TRIGGERS - Use when user needs help with ai-entity-extractor related tasks.
category: AI & Automation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/ai-entity-extractor/SKILL.md"
license: "MIT"
