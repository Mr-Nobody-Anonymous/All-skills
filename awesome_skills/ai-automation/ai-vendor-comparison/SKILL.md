...
description: |
  Compare AI vendors and platforms with evaluation criteria and scoring.
  TRIGGERS - Use when user needs help with ai-vendor-comparison related tasks.
category: AI & Automation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/ai-vendor-comparison/SKILL.md"
license: "MIT"
