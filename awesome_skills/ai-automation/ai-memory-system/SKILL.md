...
description: |
  Design AI memory systems with context management.
  TRIGGERS - Use when user needs help with ai-memory-system related tasks.
category: AI & Automation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/ai-memory-system/SKILL.md"
license: "MIT"
