---
name: ai-playground-builder
description: |
  Build playgrounds for AI model testing.
  TRIGGERS - Use when user needs help with ai-playground-builder related tasks.
category: AI & Automation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/ai-playground-builder/SKILL.md"
license: "MIT"
