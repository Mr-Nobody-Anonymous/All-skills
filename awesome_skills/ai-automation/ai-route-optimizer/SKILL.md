...
description: |
  Build AI route optimization systems.
  TRIGGERS - Use when user needs help with ai-route-optimizer related tasks.
category: AI & Automation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/ai-route-optimizer/SKILL.md"
license: "MIT"
