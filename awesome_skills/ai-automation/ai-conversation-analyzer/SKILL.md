...
description: |
  Build AI conversation analytics systems.
  TRIGGERS - Use when user needs help with ai-conversation-analyzer related tasks.
category: AI & Automation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/ai-conversation-analyzer/SKILL.md"
license: "MIT"
