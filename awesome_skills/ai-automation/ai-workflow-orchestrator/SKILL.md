...
description: |
  Design AI workflow orchestration with decisions.
  TRIGGERS - Use when user needs help with ai-workflow-orchestrator related tasks.
category: AI & Automation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/ai-workflow-orchestrator/SKILL.md"
license: "MIT"
