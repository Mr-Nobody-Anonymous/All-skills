...
description: |
  Design AI email assistants with drafting and triage.
  TRIGGERS - Use when user needs help with ai-email-assistant related tasks.
category: AI & Automation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/ai-email-assistant/SKILL.md"
license: "MIT"
