...
description: |
  Plan scheduled jobs with timing, dependencies, and monitoring.
  TRIGGERS - Use when user needs help with cron-job-planner related tasks.
category: AI & Automation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/cron-job-planner/SKILL.md"
license: "MIT"
