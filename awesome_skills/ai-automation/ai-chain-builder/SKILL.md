...
description: |
  Build AI prompt chains and multi-step workflows for complex tasks.
  TRIGGERS - Use when user needs help with ai-chain-builder related tasks.
category: AI & Automation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/ai-chain-builder/SKILL.md"
license: "MIT"
