...
description: |
  Assess AI risks including bias, security, privacy, and reliability.
  TRIGGERS - Use when user needs help with ai-risk-assessment related tasks.
category: AI & Automation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/ai-risk-assessment/SKILL.md"
license: "MIT"
