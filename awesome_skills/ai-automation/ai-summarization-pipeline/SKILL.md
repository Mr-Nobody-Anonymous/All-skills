...
description: |
  Design document summarization pipelines with quality control.
  TRIGGERS - Use when user needs help with ai-summarization-pipeline related tasks.
category: AI & Automation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/ai-summarization-pipeline/SKILL.md"
license: "MIT"
