...
description: |
  Analyze build vs buy decisions for AI solutions.
  TRIGGERS - Use when user needs help with ai-build-vs-buy related tasks.
category: AI & Automation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/ai-build-vs-buy/SKILL.md"
license: "MIT"
