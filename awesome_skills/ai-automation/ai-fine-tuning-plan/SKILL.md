---
name: ai-fine-tuning-plan
description: |
  Plan AI fine-tuning projects with data preparation, training, and evaluation.
  TRIGGERS - Use when user needs help with ai-fine-tuning-plan related tasks.
category: AI & Automation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/ai-fine-tuning-plan/SKILL.md"
license: "MIT"
