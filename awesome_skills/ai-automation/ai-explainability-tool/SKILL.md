---
name: ai-explainability-tool
description: |
  Build explainability tools for AI decisions.
  TRIGGERS - Use when user needs help with ai-explainability-tool related tasks.
category: AI & Automation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/ai-explainability-tool/SKILL.md"
license: "MIT"
