...
description: |
  Design AI content detection systems for authenticity verification.
  TRIGGERS - Use when user needs help with ai-content-detector related tasks.
category: AI & Automation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/ai-content-detector/SKILL.md"
license: "MIT"
