...
description: |
  Build usage dashboards for AI platforms.
  TRIGGERS - Use when user needs help with ai-usage-dashboard related tasks.
category: AI & Automation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/ai-usage-dashboard/SKILL.md"
license: "MIT"
