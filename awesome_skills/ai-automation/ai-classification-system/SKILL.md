...
description: |
  Build text and data classification systems with training and evaluation.
  TRIGGERS - Use when user needs help with ai-classification-system related tasks.
category: AI & Automation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/ai-classification-system/SKILL.md"
license: "MIT"
