...
description: |
  Create checklists for download and engagement.
  TRIGGERS - Use when user needs help with checklist-creator related tasks.
category: Content Creation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/checklist-creator/SKILL.md"
license: "MIT"
