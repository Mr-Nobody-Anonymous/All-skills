---
name: guest-post-pitcher
description: |
  Write guest post pitches with topic ideas, credentials, and value propositions.
  TRIGGERS - Use when user needs help with guest-post-pitcher related tasks.
category: Content Creation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/guest-post-pitcher/SKILL.md"
license: "MIT"
