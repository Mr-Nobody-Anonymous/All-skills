...
name: content-audit
description: |
  Audit existing content for quality, relevance, and optimization opportunities.
  TRIGGERS - Use when user needs help with content-audit related tasks.
category: Content Creation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/content-audit/SKILL.md"
license: "MIT"
