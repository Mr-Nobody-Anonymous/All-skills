...
description: |
  Structure narratives using storytelling frameworks for maximum impact.
  TRIGGERS - Use when user needs help with storytelling-framework related tasks.
category: Content Creation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/storytelling-framework/SKILL.md"
license: "MIT"
