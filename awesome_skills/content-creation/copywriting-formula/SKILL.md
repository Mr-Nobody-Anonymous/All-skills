...
description: |
  Apply proven copywriting formulas (AIDA, PAS, BAB) to any content.
  TRIGGERS - Use when user needs help with copywriting-formula related tasks.
category: Content Creation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/copywriting-formula/SKILL.md"
license: "MIT"
