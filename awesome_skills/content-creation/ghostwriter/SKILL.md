...
name: ghostwriter
description: |
  Write content in another person's voice with style matching and tone consistency.
  TRIGGERS - Use when user needs help with ghostwriter related tasks.
category: Content Creation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/ghostwriter/SKILL.md"
license: "MIT"
