...
description: |
  Write professional reference letters with specific examples and endorsements.
  TRIGGERS - Use when user needs help with reference-letter related tasks.
category: Content Creation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/reference-letter/SKILL.md"
license: "MIT"
