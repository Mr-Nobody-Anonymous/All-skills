---
name: content-upgrade-plan
description: |
  Design content upgrades for lead capture.
  TRIGGERS - Use when user needs help with content-upgrade-plan related tasks.
category: Content Creation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/content-upgrade-plan/SKILL.md"
license: "MIT"
