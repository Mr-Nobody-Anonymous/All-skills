---
name: book-outline-creator
description: |
  Create detailed book outlines with chapter summaries and key themes.
  TRIGGERS - Use when user needs help with book-outline-creator related tasks.
category: Content Creation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/book-outline-creator/SKILL.md"
license: "MIT"
