---
name: speaker-bio-writer
description: |
  Write speaker bios for conferences, events, and media appearances.
  TRIGGERS - Use when user needs help with speaker-bio-writer related tasks.
category: Content Creation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/speaker-bio-writer/SKILL.md"
license: "MIT"
