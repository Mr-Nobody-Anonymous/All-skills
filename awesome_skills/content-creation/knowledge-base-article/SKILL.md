...
description: |
  Write knowledge base articles with clear steps and troubleshooting guides.
  TRIGGERS - Use when user needs help with knowledge-base-article related tasks.
category: Content Creation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/knowledge-base-article/SKILL.md"
license: "MIT"
