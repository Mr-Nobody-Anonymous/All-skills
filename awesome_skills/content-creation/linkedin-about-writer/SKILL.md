...
description: |
  Write LinkedIn About sections with storytelling and keyword optimization.
  TRIGGERS - Use when user needs help with linkedin-about-writer related tasks.
category: Content Creation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/linkedin-about-writer/SKILL.md"
license: "MIT"
