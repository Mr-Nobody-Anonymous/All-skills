---
name: pas-copy-writer
description: |
  Write copy using the PAS framework: Problem, Agitate, Solution.
  TRIGGERS - Use when user needs help with pas-copy-writer related tasks.
category: Content Creation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/pas-copy-writer/SKILL.md"
license: "MIT"
