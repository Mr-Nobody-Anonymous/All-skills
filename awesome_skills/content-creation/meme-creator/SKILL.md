...
name: meme-creator
description: |
  Create meme concepts with trending formats, captions, and brand alignment.
  TRIGGERS - Use when user needs help with meme-creator related tasks.
category: Content Creation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/meme-creator/SKILL.md"
license: "MIT"
