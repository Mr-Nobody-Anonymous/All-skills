...
name: cta-optimizer
description: |
  Optimize calls-to-action for higher click-through and conversion rates.
  TRIGGERS - Use when user needs help with cta-optimizer related tasks.
category: Content Creation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/cta-optimizer/SKILL.md"
license: "MIT"
