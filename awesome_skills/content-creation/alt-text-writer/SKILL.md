...
description: |
  Write accessible and SEO-friendly alt text for images.
  TRIGGERS - Use when user needs help with alt-text-writer related tasks.
category: Content Creation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/alt-text-writer/SKILL.md"
license: "MIT"
