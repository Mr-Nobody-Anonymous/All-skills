...
description: |
  Create interview preparation guides with questions, research, and talking points.
  TRIGGERS - Use when user needs help with interview-prep-guide related tasks.
category: Content Creation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/interview-prep-guide/SKILL.md"
license: "MIT"
