...
description: |
  Write author bios for books, articles, and speaking engagements.
  TRIGGERS - Use when user needs help with author-bio-writer related tasks.
category: Content Creation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/author-bio-writer/SKILL.md"
license: "MIT"
