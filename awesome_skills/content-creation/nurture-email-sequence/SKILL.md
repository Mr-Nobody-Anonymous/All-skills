...
description: |
  Write lead nurture email sequences.
  TRIGGERS - Use when user needs help with nurture-email-sequence related tasks.
category: Content Creation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/nurture-email-sequence/SKILL.md"
license: "MIT"
