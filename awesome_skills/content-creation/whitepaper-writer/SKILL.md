...
description: |
  Write authoritative whitepapers with research, analysis, and recommendations.
  TRIGGERS - Use when user needs help with whitepaper-writer related tasks.
category: Content Creation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/whitepaper-writer/SKILL.md"
license: "MIT"
