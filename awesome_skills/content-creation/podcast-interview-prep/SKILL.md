...
description: |
  Prepare podcast interview outlines with questions, transitions, and hooks.
  TRIGGERS - Use when user needs help with podcast-interview-prep related tasks.
category: Content Creation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/podcast-interview-prep/SKILL.md"
license: "MIT"
