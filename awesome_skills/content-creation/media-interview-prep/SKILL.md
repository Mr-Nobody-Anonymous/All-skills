---
name: media-interview-prep
description: |
  Prepare for media interviews with key messages, bridging, and Q&A prep.
  TRIGGERS - Use when user needs help with media-interview-prep related tasks.
category: Content Creation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/media-interview-prep/SKILL.md"
license: "MIT"
