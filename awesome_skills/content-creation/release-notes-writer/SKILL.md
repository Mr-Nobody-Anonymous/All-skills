...
description: |
  Write release notes with new features, fixes, and migration guides.
  TRIGGERS - Use when user needs help with release-notes-writer related tasks.
category: Content Creation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/release-notes-writer/SKILL.md"
license: "MIT"
