...
description: |
  Write LinkedIn recommendations that highlight specific contributions and skills.
  TRIGGERS - Use when user needs help with linkedin-recommendation related tasks.
category: Content Creation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/linkedin-recommendation/SKILL.md"
license: "MIT"
