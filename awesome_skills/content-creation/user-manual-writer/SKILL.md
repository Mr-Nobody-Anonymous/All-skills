...
description: |
  Write user manuals with clear instructions, diagrams, and troubleshooting.
  TRIGGERS - Use when user needs help with user-manual-writer related tasks.
category: Content Creation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/user-manual-writer/SKILL.md"
license: "MIT"
