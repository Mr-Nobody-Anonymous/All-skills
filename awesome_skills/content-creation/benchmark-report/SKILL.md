...
description: |
  Create benchmark report templates with data.
  TRIGGERS - Use when user needs help with benchmark-report related tasks.
category: Content Creation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/benchmark-report/SKILL.md"
license: "MIT"
