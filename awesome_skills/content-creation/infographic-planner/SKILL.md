...
description: |
  Plan infographics with data points, visual flow, and copy for each section.
  TRIGGERS - Use when user needs help with infographic-planner related tasks.
category: Content Creation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/infographic-planner/SKILL.md"
license: "MIT"
