...
description: |
  Create brand journalism programs with editorial.
  TRIGGERS - Use when user needs help with brand-journalism related tasks.
category: Content Creation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/brand-journalism/SKILL.md"
license: "MIT"
