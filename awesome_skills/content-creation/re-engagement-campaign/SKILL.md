...
description: |
  Write re-engagement email campaigns.
  TRIGGERS - Use when user needs help with re-engagement-campaign related tasks.
category: Content Creation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/re-engagement-campaign/SKILL.md"
license: "MIT"
