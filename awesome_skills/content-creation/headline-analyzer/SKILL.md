...
description: |
  Analyze and optimize headlines for clicks, clarity, and emotional impact.
  TRIGGERS - Use when user needs help with headline-analyzer related tasks.
category: Content Creation
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/headline-analyzer/SKILL.md"
license: "MIT"
