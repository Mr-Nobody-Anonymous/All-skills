...
description: |
  Design marketing attribution models for multi-touch customer journeys.
  TRIGGERS - Use when user needs help with attribution-model related tasks.
category: Data & Analytics
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/attribution-model/SKILL.md"
license: "MIT"
