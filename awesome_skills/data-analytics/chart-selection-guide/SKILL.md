...
description: |
  Guide chart type selection for data.
  TRIGGERS - Use when user needs help with chart-selection-guide related tasks.
category: Data & Analytics
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/chart-selection-guide/SKILL.md"
license: "MIT"
