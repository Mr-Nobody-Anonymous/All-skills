...
description: |
  Analyze purchase basket data for cross-sell and merchandising insights.
  TRIGGERS - Use when user needs help with basket-analysis related tasks.
category: Data & Analytics
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/basket-analysis/SKILL.md"
license: "MIT"
