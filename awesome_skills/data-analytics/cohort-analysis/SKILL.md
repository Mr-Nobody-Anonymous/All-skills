...
description: |
  Perform cohort analysis to track user behavior over time.
  TRIGGERS - Use when user needs help with cohort-analysis related tasks.
category: Data & Analytics
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/cohort-analysis/SKILL.md"
license: "MIT"
