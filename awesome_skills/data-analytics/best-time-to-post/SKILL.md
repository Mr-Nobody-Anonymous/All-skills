...
description: |
  Determine optimal posting times based on audience activity data.
  TRIGGERS - Use when user needs help with best-time-to-post related tasks.
category: Data & Analytics
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/best-time-to-post/SKILL.md"
license: "MIT"
