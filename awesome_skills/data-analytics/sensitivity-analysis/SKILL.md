...
description: |
  Run sensitivity analysis on key variables to understand business model risks.
  TRIGGERS - Use when user needs help with sensitivity-analysis related tasks.
category: Data & Analytics
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/sensitivity-analysis/SKILL.md"
license: "MIT"
