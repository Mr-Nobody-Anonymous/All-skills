...
description: |
  Set up web analytics with GA4 configuration.
  TRIGGERS - Use when user needs help with web-analytics-setup related tasks.
category: Data & Analytics
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/web-analytics-setup/SKILL.md"
license: "MIT"
