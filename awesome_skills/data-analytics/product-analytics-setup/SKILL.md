...
description: |
  Set up product analytics with events.
  TRIGGERS - Use when user needs help with product-analytics-setup related tasks.
category: Data & Analytics
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/product-analytics-setup/SKILL.md"
license: "MIT"
