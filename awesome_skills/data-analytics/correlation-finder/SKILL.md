...
description: |
  Identify correlations in data sets and distinguish from causation.
  TRIGGERS - Use when user needs help with correlation-finder related tasks.
category: Data & Analytics
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/correlation-finder/SKILL.md"
license: "MIT"
