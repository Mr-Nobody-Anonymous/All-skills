...
description: |
  Identify content gaps compared to competitors and search demand.
  TRIGGERS - Use when user needs help with content-gap-analyzer related tasks.
category: Data & Analytics
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/content-gap-analyzer/SKILL.md"
license: "MIT"
