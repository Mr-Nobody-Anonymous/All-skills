---
name: channel-mix-model
description: |
  Build channel mix models to optimize marketing spend allocation.
  TRIGGERS - Use when user needs help with channel-mix-model related tasks.
category: Data & Analytics
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/channel-mix-model/SKILL.md"
license: "MIT"
