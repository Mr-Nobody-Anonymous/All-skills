...
name: serp-analyzer
description: |
  Analyze search engine results pages for competitive insights and opportunities.
  TRIGGERS - Use when user needs help with serp-analyzer related tasks.
category: Data & Analytics
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/serp-analyzer/SKILL.md"
license: "MIT"
