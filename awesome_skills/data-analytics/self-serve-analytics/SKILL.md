...
description: |
  Build self-serve analytics platforms.
  TRIGGERS - Use when user needs help with self-serve-analytics related tasks.
category: Data & Analytics
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/self-serve-analytics/SKILL.md"
license: "MIT"
