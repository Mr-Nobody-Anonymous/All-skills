...
description: |
  Design accessibility features for games.
  TRIGGERS - Use when user needs help with game-accessibility related tasks.
category: Gaming
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/game-accessibility/SKILL.md"
license: "MIT"
