---
name: game-user-acquisition
description: |
  Design game user acquisition.
  TRIGGERS - Use when user needs help with game-user-acquisition related tasks.
category: Gaming
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/game-user-acquisition/SKILL.md"
license: "MIT"
