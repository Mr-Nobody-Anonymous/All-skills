...
description: |
  Design anti-cheat strategies for online games.
  TRIGGERS - Use when user needs help with anti-cheat-strategy related tasks.
category: Gaming
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/anti-cheat-strategy/SKILL.md"
license: "MIT"
