...
name: game-ux-audit
description: |
  Audit game UX with player experience analysis.
  TRIGGERS - Use when user needs help with game-ux-audit related tasks.
category: Gaming
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/game-ux-audit/SKILL.md"
license: "MIT"
