...
name: game-ui-design
description: |
  Design game user interfaces with wireframes.
  TRIGGERS - Use when user needs help with game-ui-design related tasks.
category: Gaming
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/game-ui-design/SKILL.md"
license: "MIT"
