---
name: mobile-game-plan
description: |
  Create mobile game development and launch plans.
  TRIGGERS - Use when user needs help with mobile-game-plan related tasks.
category: Gaming
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/mobile-game-plan/SKILL.md"
license: "MIT"
