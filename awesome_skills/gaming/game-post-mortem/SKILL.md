---
name: game-post-mortem
description: |
  Write game development post-mortems with analysis.
  TRIGGERS - Use when user needs help with game-post-mortem related tasks.
category: Gaming
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/game-post-mortem/SKILL.md"
license: "MIT"
