...
description: |
  Design matchmaking systems for multiplayer games.
  TRIGGERS - Use when user needs help with matchmaking-design related tasks.
category: Gaming
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/matchmaking-design/SKILL.md"
license: "MIT"
