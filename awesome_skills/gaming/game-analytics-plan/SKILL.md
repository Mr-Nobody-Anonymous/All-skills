---
name: game-analytics-plan
description: |
  Design game analytics with player behavior tracking.
  TRIGGERS - Use when user needs help with game-analytics-plan related tasks.
category: Gaming
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/game-analytics-plan/SKILL.md"
license: "MIT"
