---
name: game-dlc-strategy
description: |
  Design DLC strategies.
  TRIGGERS - Use when user needs help with game-dlc-strategy related tasks.
category: Gaming
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/game-dlc-strategy/SKILL.md"
license: "MIT"
