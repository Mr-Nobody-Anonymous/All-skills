---
name: game-marketing-plan
description: |
  Create game marketing plans with launch strategies.
  TRIGGERS - Use when user needs help with game-marketing-plan related tasks.
category: Gaming
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/game-marketing-plan/SKILL.md"
license: "MIT"
