---
name: mobile-game-strategy
description: |
  Create mobile game strategies with UA and retention.
  TRIGGERS - Use when user needs help with mobile-game-strategy related tasks.
category: Gaming
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/mobile-game-strategy/SKILL.md"
license: "MIT"
