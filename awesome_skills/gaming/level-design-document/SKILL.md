...
description: |
  Write level design documents with layout and flow.
  TRIGGERS - Use when user needs help with level-design-document related tasks.
category: Gaming
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/level-design-document/SKILL.md"
license: "MIT"
