...
description: |
  Design podcast monetization strategies.
  TRIGGERS - Use when user needs help with podcast-monetization related tasks.
category: Journalism
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/podcast-monetization/SKILL.md"
license: "MIT"
