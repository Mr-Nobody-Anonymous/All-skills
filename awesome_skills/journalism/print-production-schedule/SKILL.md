---
name: print-production-schedule
description: |
  Create print production schedules with deadlines.
  TRIGGERS - Use when user needs help with print-production-schedule related tasks.
category: Journalism
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/print-production-schedule/SKILL.md"
license: "MIT"
