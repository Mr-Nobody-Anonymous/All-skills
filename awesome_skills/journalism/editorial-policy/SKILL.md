...
description: |
  Create editorial policies with standards and ethics.
  TRIGGERS - Use when user needs help with editorial-policy related tasks.
category: Journalism
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/editorial-policy/SKILL.md"
license: "MIT"
