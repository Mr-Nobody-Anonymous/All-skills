...
description: |
  Create editorial style guides with standards.
  TRIGGERS - Use when user needs help with editorial-style-guide related tasks.
category: Journalism
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/editorial-style-guide/SKILL.md"
license: "MIT"
