---
name: book-launch-plan
description: |
  Plan book launches with marketing and events.
  TRIGGERS - Use when user needs help with book-launch-plan related tasks.
category: Journalism
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/book-launch-plan/SKILL.md"
license: "MIT"
