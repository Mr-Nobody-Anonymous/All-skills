...
description: |
  Evaluate manuscripts with editorial criteria.
  TRIGGERS - Use when user needs help with manuscript-evaluation related tasks.
category: Journalism
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/manuscript-evaluation/SKILL.md"
license: "MIT"
