---
name: pet-adoption-guide
description: |
  Create pet adoption guides and processes.
  TRIGGERS - Use when user needs help with pet-adoption-guide related tasks.
...
source_path: "skills/pet-adoption-guide/SKILL.md"
license: "MIT"
