---
name: pet-emergency-plan
description: |
  Design pet emergency preparedness plans.
  TRIGGERS - Use when user needs help with pet-emergency-plan related tasks.
...
source_path: "skills/pet-emergency-plan/SKILL.md"
license: "MIT"
