...
description: |
  Create social media strategies for pet businesses.
  TRIGGERS - Use when user needs help with pet-social-media related tasks.
...
source_path: "skills/pet-social-media/SKILL.md"
license: "MIT"
