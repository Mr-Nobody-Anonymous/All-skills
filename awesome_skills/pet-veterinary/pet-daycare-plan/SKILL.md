---
name: pet-daycare-plan
description: |
  Create pet daycare business plans.
  TRIGGERS - Use when user needs help with pet-daycare-plan related tasks.
...
source_path: "skills/pet-daycare-plan/SKILL.md"
license: "MIT"
