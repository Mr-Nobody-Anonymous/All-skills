---
name: pet-store-marketing
description: |
  Create marketing plans for pet stores.
  TRIGGERS - Use when user needs help with pet-store-marketing related tasks.
...
source_path: "skills/pet-store-marketing/SKILL.md"
license: "MIT"
