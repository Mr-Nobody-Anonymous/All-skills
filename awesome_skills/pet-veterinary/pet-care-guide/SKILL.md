...
name: pet-care-guide
description: |
  Write pet care guides for different species.
  TRIGGERS - Use when user needs help with pet-care-guide related tasks.
...
source_path: "skills/pet-care-guide/SKILL.md"
license: "MIT"
