...
description: |
  Create dog walking business plans.
  TRIGGERS - Use when user needs help with dog-walking-business related tasks.
...
source_path: "skills/dog-walking-business/SKILL.md"
license: "MIT"
