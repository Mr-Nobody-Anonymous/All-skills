---
name: veterinary-protocol
description: |
  Create veterinary treatment protocols.
  TRIGGERS - Use when user needs help with veterinary-protocol related tasks.
...
source_path: "skills/veterinary-protocol/SKILL.md"
license: "MIT"
