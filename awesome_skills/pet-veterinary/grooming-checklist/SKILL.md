...
description: |
  Create grooming checklists for pet care.
  TRIGGERS - Use when user needs help with grooming-checklist related tasks.
...
source_path: "skills/grooming-checklist/SKILL.md"
license: "MIT"
