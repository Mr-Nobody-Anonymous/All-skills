---
name: pet-boarding-plan
description: |
  Design pet boarding facility operations.
  TRIGGERS - Use when user needs help with pet-boarding-plan related tasks.
...
source_path: "skills/pet-boarding-plan/SKILL.md"
license: "MIT"
