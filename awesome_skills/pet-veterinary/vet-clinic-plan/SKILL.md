---
name: vet-clinic-plan
description: |
  Create veterinary clinic business plans.
  TRIGGERS - Use when user needs help with vet-clinic-plan related tasks.
...
source_path: "skills/vet-clinic-plan/SKILL.md"
license: "MIT"
