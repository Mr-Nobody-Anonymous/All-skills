---
name: pet-nutrition-plan
description: |
  Create pet nutrition plans with feeding guidelines.
  TRIGGERS - Use when user needs help with pet-nutrition-plan related tasks.
...
source_path: "skills/pet-nutrition-plan/SKILL.md"
license: "MIT"
