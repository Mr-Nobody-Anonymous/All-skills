---
name: veterinary-marketing
description: |
  Create marketing plans for veterinary practices.
  TRIGGERS - Use when user needs help with veterinary-marketing related tasks.
...
source_path: "skills/veterinary-marketing/SKILL.md"
license: "MIT"
