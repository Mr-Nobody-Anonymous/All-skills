---
name: music-sync-strategy
description: |
  Design music sync licensing strategies.
  TRIGGERS - Use when user needs help with music-sync-strategy related tasks.
category: Music Industry
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/music-sync-strategy/SKILL.md"
license: "MIT"
