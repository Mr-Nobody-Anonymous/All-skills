...
description: |
  Design nutrition coaching programs with protocols.
  TRIGGERS - Use when user needs help with nutrition-coaching-program related tasks.
category: Beauty & Wellness
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/nutrition-coaching-program/SKILL.md"
license: "MIT"
