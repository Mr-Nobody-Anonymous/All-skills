...
description: |
  Design corporate wellness programs with activities.
  TRIGGERS - Use when user needs help with wellness-program-designer related tasks.
category: Beauty & Wellness
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/wellness-program-designer/SKILL.md"
license: "MIT"
