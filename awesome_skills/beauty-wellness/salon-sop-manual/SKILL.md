---
name: salon-sop-manual
description: |
  Write standard operating procedures for salons.
  TRIGGERS - Use when user needs help with salon-sop-manual related tasks.
category: Beauty & Wellness
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/salon-sop-manual/SKILL.md"
license: "MIT"
