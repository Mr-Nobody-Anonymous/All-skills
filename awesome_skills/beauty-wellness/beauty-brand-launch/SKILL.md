...
description: |
  Plan beauty brand launches with positioning and marketing.
  TRIGGERS - Use when user needs help with beauty-brand-launch related tasks.
category: Beauty & Wellness
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/beauty-brand-launch/SKILL.md"
license: "MIT"
