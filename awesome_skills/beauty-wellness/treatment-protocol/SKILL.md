...
description: |
  Create treatment protocols for beauty and wellness services.
  TRIGGERS - Use when user needs help with treatment-protocol related tasks.
category: Beauty & Wellness
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/treatment-protocol/SKILL.md"
license: "MIT"
