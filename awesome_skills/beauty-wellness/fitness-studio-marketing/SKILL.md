---
name: fitness-studio-marketing
description: |
  Create marketing plans for fitness studios.
  TRIGGERS - Use when user needs help with fitness-studio-marketing related tasks.
category: Beauty & Wellness
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/fitness-studio-marketing/SKILL.md"
license: "MIT"
