...
description: |
  Write aftercare instructions for beauty treatments.
  TRIGGERS - Use when user needs help with aftercare-instructions related tasks.
category: Beauty & Wellness
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/aftercare-instructions/SKILL.md"
license: "MIT"
