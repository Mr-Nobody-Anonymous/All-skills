---
name: spa-marketing-plan
description: |
  Create spa marketing plans with seasonal promotions.
  TRIGGERS - Use when user needs help with spa-marketing-plan related tasks.
category: Beauty & Wellness
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/spa-marketing-plan/SKILL.md"
license: "MIT"
