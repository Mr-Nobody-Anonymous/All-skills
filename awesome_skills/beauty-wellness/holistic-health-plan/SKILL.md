---
name: holistic-health-plan
description: |
  Create holistic health plans with modalities.
  TRIGGERS - Use when user needs help with holistic-health-plan related tasks.
category: Beauty & Wellness
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/holistic-health-plan/SKILL.md"
license: "MIT"
