...
description: |
  Create product review templates for beauty content.
  TRIGGERS - Use when user needs help with product-review-template related tasks.
category: Beauty & Wellness
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/product-review-template/SKILL.md"
license: "MIT"
