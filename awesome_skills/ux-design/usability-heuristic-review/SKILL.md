...
description: |
  Conduct heuristic usability reviews.
  TRIGGERS - Use when user needs help with usability-heuristic-review related tasks.
category: UX Design
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/usability-heuristic-review/SKILL.md"
license: "MIT"
