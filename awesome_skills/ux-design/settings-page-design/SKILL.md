...
description: |
  Design settings page patterns.
  TRIGGERS - Use when user needs help with settings-page-design related tasks.
category: UX Design
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/settings-page-design/SKILL.md"
license: "MIT"
