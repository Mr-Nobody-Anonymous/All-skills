---
name: persona-builder-ux
description: |
  Build user personas for design.
  TRIGGERS - Use when user needs help with persona-builder-ux related tasks.
category: UX Design
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/persona-builder-ux/SKILL.md"
license: "MIT"
