...
description: "Formal Languages, Grammars & Computability: Deterministic and non-deterministic finite automata (DFA/NFA), regular expressions, context-free grammars (Chomsky hierarchy), pushdown automata, and Turing machines / Halting problem."
...
# Formal Languages, Grammars & Computability

Deterministic and non-deterministic finite automata (DFA/NFA), regular expressions, context-free grammars (Chomsky hierarchy), pushdown automata, and Turing machines / Halting problem.

## Standard Operating Procedure & Methodology

### 1. Conceptual & Theoretical Foundations
Formulate the theoretical principles governing formal languages, grammars & computability:
