...
description: "Distributed Consensus & Fault Tolerance: CAP theorem, PACELC, distributed transactions (2PC, 3PC), Paxos, Raft consensus protocol, vector clocks, Byzantine fault tolerance (BFT), and eventual consistency."
...
CAP theorem, PACELC, distributed transactions (2PC, 3PC), Paxos, Raft consensus protocol, vector clocks, Byzantine fault tolerance (BFT), and eventual consistency.

## Standard Operating Procedure & Methodology

### 1. Conceptual & Theoretical Foundations
Formulate the theoretical principles governing distributed consensus & fault tolerance:
