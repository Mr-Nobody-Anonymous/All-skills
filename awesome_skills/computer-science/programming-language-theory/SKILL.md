...
description: "Formal Operational & Denotational Semantics: Small-step and big-step operational semantics, lambda calculus (untyped, typed), substitution lemmas, evaluation strategies (call-by-value, call-by-name), and lambda abstractions."
...
# Formal Operational & Denotational Semantics

Small-step and big-step operational semantics, lambda calculus (untyped, typed), substitution lemmas, evaluation strategies (call-by-value, call-by-name), and lambda abstractions.

## Standard Operating Procedure & Methodology

### 1. Conceptual & Theoretical Foundations
Formulate the theoretical principles governing formal operational & denotational semantics:
