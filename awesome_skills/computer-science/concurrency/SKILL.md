---
name: concurrency
description: "Concurrent Programming & Memory Models: Threads, fibers, mutexes, condition variables, lock-free data structures (CAS loops), ABA problem, memory barriers, acquire-release semantics, and deadlocks/race conditions."
...
Threads, fibers, mutexes, condition variables, lock-free data structures (CAS loops), ABA problem, memory barriers, acquire-release semantics, and deadlocks/race conditions.

## Standard Operating Procedure & Methodology

### 1. Conceptual & Theoretical Foundations
Formulate the theoretical principles governing concurrent programming & memory models:
