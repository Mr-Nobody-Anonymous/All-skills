---
name: type-systems
description: "Type Theory, Inference & Soundness Proofs: Hindley-Milner type inference (Algorithm W), subtyping, parametric polymorphism, algebraic data types, linear/affine types, and progress & preservation type soundness theorems."
...
# Type Theory, Inference & Soundness Proofs

Hindley-Milner type inference (Algorithm W), subtyping, parametric polymorphism, algebraic data types, linear/affine types, and progress & preservation type soundness theorems.

## Standard Operating Procedure & Methodology

### 1. Conceptual & Theoretical Foundations
Formulate the theoretical principles governing type theory, inference & soundness proofs:
