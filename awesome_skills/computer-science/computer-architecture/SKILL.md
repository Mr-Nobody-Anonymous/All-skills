...
description: "Instruction Set Architecture & Microarchitecture: Von Neumann vs Harvard architectures, RISC vs CISC (x86_64, ARM64, RISC-V), 5-stage CPU pipelines, branch prediction, superscalar out-of-order execution, and memory hierarchies."
...
Von Neumann vs Harvard architectures, RISC vs CISC (x86_64, ARM64, RISC-V), 5-stage CPU pipelines, branch prediction, superscalar out-of-order execution, and memory hierarchies.

## Standard Operating Procedure & Methodology

### 1. Conceptual & Theoretical Foundations
Formulate the theoretical principles governing instruction set architecture & microarchitecture:
