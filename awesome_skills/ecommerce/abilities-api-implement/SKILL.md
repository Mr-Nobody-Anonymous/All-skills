...
description: "'End-to-end implementation playbook for registering WordPress Abilities API capabilities in a WooCommerce extension. Builds on the portable skills in WordPress/agent-skills (`wp-abilities-api`, `wp-abilities-audit`, `wp-abilities-verify`) and adds the Woo-extension scaffolding, conventions, and PR w"
category: ecommerce
version: 1.0.0
disable-model-invocation: false
risk: low
source: "https://github.com/woocommerce/agent-skills"
source_repository: "woocommerce/agent-skills"
source_path: "skills/abilities-api-implement/SKILL.md"
license: "GPL-3.0"
