---
name: skill
description: "Imported from Shopify/agent-skills"
category: general
version: 1.0.0
disable-model-invocation: false
risk: low
source: "https://github.com/Shopify/agent-skills"
source_repository: "Shopify/agent-skills"
source_path: "shopify-liquid/SKILL.md"
license: "MIT"
...
```
/scripts/validate.js --theme-path <absolute-path-to-theme> --files <rel1,rel2,...>
```
...
```
/scripts/validate.js --filename <name.liquid> --filetype <sections|blocks|snippets|layout|templates|locales|config|assets> --code <content>
```
...
2. Search for the correct syntax or usage:
   ```
   /scripts/search_docs.js "<tag, filter, or object name>"
   ```
