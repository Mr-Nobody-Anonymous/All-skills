...
description: When the user wants to improve their ability to craft compelling emails, proposals, and follow-ups in sales. Also use when the user mentions "writing emails," "sales proposals," "follow-up messages," "written pitches," "professional communication," or "email copy."
source: "https://github.com/louisblythe/Sales-Skills"
source_repository: "louisblythe/Sales-Skills"
source_path: "skills/written-communication/SKILL.md"
license: "MIT"
...
**First Line:** Get it read
**Body:** Create interest
**CTA:** Get action
...
**Weak:** "Hi, my name is Alex and I'm a sales rep at XYZ Corp."
**Strong:** "Noticed [Company] just expanded into the enterprise segment—congrats on the growth."

**Weak:** "I wanted to reach out to introduce our platform."
**Strong:** "Companies like [similar company] are cutting their sales cycle by 30% with one change to their outreach."
...
**Structure:**
1. Hook (personalized connection or insight)
2. Value (what's in it for them)
3. Proof (quick credibility)
...
**First pass:** Cut unnecessary words
**Second pass:** Strengthen weak language
**Third pass:** Check the CTA is clear
**Fourth pass:** Read aloud (does it sound natural?)
...
1. What type of written communication do you send most?
2. What response rates are you currently seeing?
3. Can you share an example email you've sent?
4. Who is your target audience?
5. What action are you trying to drive?
