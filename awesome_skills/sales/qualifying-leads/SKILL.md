...
description: When the user wants to improve their ability to quickly identify who's worth pursuing in sales. Also use when the user mentions "qualifying prospects," "lead scoring," "identifying good fits," "wasting time on bad leads," "qualification criteria," or "is this worth pursuing."
source: "https://github.com/louisblythe/Sales-Skills"
source_repository: "louisblythe/Sales-Skills"
source_path: "skills/qualifying-leads/SKILL.md"
license: "MIT"
...
**Wrong timing:**
"It sounds like the timing isn't right. I'd rather we reconnect when [conditions change] than force something now. Can I check back in [timeframe]?"

**Wrong fit:**
"Based on what you've shared, I don't think we're the best fit for your situation. You might want to look at [alternative]. If things change, I'm here."

**Missing key criteria:**
"Without [budget/authority/need], we might not be able to make progress right now. What would need to change for this to become a priority?"
...
1. What criteria do you currently use to qualify?
2. What does your ideal customer look like?
3. Where do deals typically fall through?
4. How much time do you spend on leads that don't close?
