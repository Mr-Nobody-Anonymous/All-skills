...
description: When the user wants to improve their ability to understand prospects, hear what's really being said, or become a better listener in sales conversations. Also use when the user mentions "listening skills," "understand the customer," "hear their needs," "not just waiting to pitch," or "truly understand prospects."
source: "https://github.com/louisblythe/Sales-Skills"
source_repository: "louisblythe/Sales-Skills"
source_path: "skills/active-listening/SKILL.md"
license: "MIT"
...
**Example:**
"Let me make sure I have this right. You're dealing with three main challenges: adoption with the sales team, reporting accuracy for leadership, and integration with your marketing tools. Did I miss anything?"
...
### 1. Interrupting
**Why it happens:** Excitement, wanting to help, fear of forgetting your point
**Fix:** Write notes instead of interrupting. Your point can wait.

### 2. Finishing Their Sentences
**Why it happens:** Trying to show understanding
**Fix:** Let them complete their thought—you might be wrong about where they're going

### 3. Relating Everything to Your Product
**Why it happens:** You're in sales mode
**Fix:** Stay in discovery mode longer. Understand first, solve later.

### 4. Selective Hearing
**Why it happens:** Focusing only on what supports your pitch
**Fix:** Listen for what challenges your assumptions too

### 5. Planning Your Response
**Why it happens:** Natural cognitive process
**Fix:** Trust that you'll know what to say. Focus fully on them.

### 6. Asking the Next Question Too Quickly
**Why it happens:** You have a script to follow
**Fix:** Pause after they answer. Let them add more.
...
1. What type of sales conversations do you have most often?
2. What's a recent example where you felt you missed something?
3. How do you currently take notes during calls?
4. What's your typical talk-to-listen ratio?
5. Have prospects ever told you that you didn't understand them?
