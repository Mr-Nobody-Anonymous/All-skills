...
description: |
  Generate presentation-ready pitch decks with structured slides and speaker notes.
  TRIGGERS - Use when user wants to create a pitch deck, presentation, startup deck, or investor slides.
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/pitch-deck-creator/SKILL.md"
license: "MIT"
