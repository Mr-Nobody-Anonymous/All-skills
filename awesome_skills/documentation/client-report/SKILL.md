...
name: client-report
description: |
  Generate professional client deliverable reports with findings, recommendations, and next steps.
  TRIGGERS - Use when user wants to create a client report, deliverable, or findings document.
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/client-report/SKILL.md"
license: "MIT"
