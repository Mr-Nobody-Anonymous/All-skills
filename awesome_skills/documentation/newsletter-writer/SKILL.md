...
description: |
  Write engaging newsletter editions with sections, hooks, and subscriber-growth tactics.
  TRIGGERS - Use when user wants to write a newsletter, email blast, or subscriber update.
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/newsletter-writer/SKILL.md"
license: "MIT"
