...
description: "'MSIX packaging, code signing, and distribution for WinUI 3 apps — build for release, certificate generation (winapp cert generate), certificate trust, code signing (winapp sign), self-contained deployment, CI/CD with GitHub Actions, and Microsoft Store submis"
category: desktop
version: 1.0.0
...
source:
  ...
  commit: "3a8c5b2e"
  path: "plugins/winui/agent-plugin/skills/winui-packaging/SKILL.md"
  license: "MIT"
