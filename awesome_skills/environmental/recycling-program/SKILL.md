...
description: |
  Design recycling programs for organizations.
  TRIGGERS - Use when user needs help with recycling-program related tasks.
category: Environmental
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/recycling-program/SKILL.md"
license: "MIT"
