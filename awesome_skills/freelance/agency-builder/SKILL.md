...
name: agency-builder
description: |
  Plan transition from freelancer to agency with scaling.
  TRIGGERS - Use when user needs help with agency-builder related tasks.
category: Freelance
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/agency-builder/SKILL.md"
license: "MIT"
