...
description: |
  Create client offboarding processes with handoff.
  TRIGGERS - Use when user needs help with client-offboarding related tasks.
category: Freelance
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/client-offboarding/SKILL.md"
license: "MIT"
