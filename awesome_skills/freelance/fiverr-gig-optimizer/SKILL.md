...
description: |
  Optimize Fiverr gigs for ranking and conversions.
  TRIGGERS - Use when user needs help with fiverr-gig-optimizer related tasks.
category: Freelance
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/fiverr-gig-optimizer/SKILL.md"
license: "MIT"
