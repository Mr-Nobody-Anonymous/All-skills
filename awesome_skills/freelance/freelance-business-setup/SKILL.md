...
description: |
  Set up freelance businesses with legal and financial.
  TRIGGERS - Use when user needs help with freelance-business-setup related tasks.
category: Freelance
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/freelance-business-setup/SKILL.md"
license: "MIT"
