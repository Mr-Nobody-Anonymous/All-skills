...
description: |
  Design freelance time tracking systems.
  TRIGGERS - Use when user needs help with freelance-time-tracker related tasks.
category: Freelance
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/freelance-time-tracker/SKILL.md"
license: "MIT"
