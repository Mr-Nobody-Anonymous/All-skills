...
description: |
  Design passive income strategies for freelancers.
  TRIGGERS - Use when user needs help with passive-income-strategy related tasks.
category: Freelance
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/passive-income-strategy/SKILL.md"
license: "MIT"
