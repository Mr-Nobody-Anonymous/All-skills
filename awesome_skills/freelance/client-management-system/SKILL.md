...
description: |
  Design client management systems for freelancers.
  TRIGGERS - Use when user needs help with client-management-system related tasks.
category: Freelance
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/client-management-system/SKILL.md"
license: "MIT"
