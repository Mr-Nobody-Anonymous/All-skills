...
description: ">- Compute classical engineering dimensionless numbers (Reynolds, Prandtl, Schmidt, Peclet, Froude, Weber, Biot, Fourier, Grashof, Rayleigh, Nusselt via Dittus-Boelter) from SI inputs, with validity-range warnings. Use when you need a dimensionless group for a correlation, regime check, or scale-up"
...
source_path: "skills/dimensionless-numbers/SKILL.md"
license: "MIT"
