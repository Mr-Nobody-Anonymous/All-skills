...
description: ">- Compute water and steam thermodynamic properties using the IAPWS-95 utilities exposed by `chemicals.iapws`. Use when any calculation involves pure water or steam (turbine, boiler, condensate, reboiler, BFW system). Don't use for hydrocarbon systems (use vle-flash-calculations or thermo-process-pr"
...
source_path: "skills/steam-tables-iapws/SKILL.md"
license: "MIT"
