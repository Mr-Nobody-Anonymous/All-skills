...
description: ">- Size liquid or gas control valves using `fluids.control_valve` (ISA 75.01.01 / IEC 60534 sizing equations). Returns Kv (m³/hr) and US Cv. Use when selecting a control valve or checking a vendor sizing. Don't use for relief devices (use relief-valve-sizing-api520), choked-flow check valves, or spe"
...
source_path: "skills/control-valve-sizing-isa75/SKILL.md"
license: "MIT"
