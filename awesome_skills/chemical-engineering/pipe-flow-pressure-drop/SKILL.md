...
description: ">- Estimate single-phase incompressible pipe pressure drop, Reynolds number, Darcy friction factor, and head loss for steady pipe flow, with optional minor-loss and elevation terms. Use when sizing a pump line, checking line size, or screening pressure drop in pipes. Don't use for two-phase flow (us"
...
source_path: "skills/pipe-flow-pressure-drop/SKILL.md"
license: "MIT"
