...
description: ">- Descriptive statistics, t-table confidence intervals for the mean, and simple linear regression on engineering data. Use when summarising lab or process data, computing a mean CI for sample data, or fitting a one-predictor linear regression. Don't use for autocorrelated process time-series (use t"
...
source_path: "skills/engineering-statistics/SKILL.md"
license: "MIT"
