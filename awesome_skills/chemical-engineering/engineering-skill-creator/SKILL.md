...
description: ">- Author a new skill for this repository in the established format: YAML frontmatter with `Use when... Don't use for...` description, Pitfalls catalogue, Procedure checklist, fallback strategies, JSON output envelope, and (where third-party libraries or standards are referenced) a first-use `LICENS"
...
source_path: "skills/engineering-skill-creator/SKILL.md"
license: "MIT"
