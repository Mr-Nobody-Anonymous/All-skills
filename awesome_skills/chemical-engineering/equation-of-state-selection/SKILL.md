...
description: ">- Recommend an appropriate equation of state (or activity-coefficient model) for a stated fluid system, using the same kind of decision logic that DWSIM, Aspen HYSYS, Aspen Plus, and AVEVA PRO/II publish in their property-method selection guides. Use when starting a new flow-sheet or property calcu"
...
source_path: "skills/equation-of-state-selection/SKILL.md"
license: "MIT"
