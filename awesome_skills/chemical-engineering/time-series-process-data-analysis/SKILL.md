...
description: ">- Estimate the sample autocorrelation (ACF), partial autocorrelation (PACF), and run a moving-block bootstrap for autocorrelation-aware confidence intervals on selected statistics of process time series. Use when computing CIs for supported statistics from autocorrelated process data. Don't use for"
...
source_path: "skills/time-series-process-data-analysis/SKILL.md"
license: "MIT"
