...
description: ">- Estimate distillation column theoretical stages, minimum reflux, feed-stage location, and McCabe-Thiele stair-stepping for binary or pseudo-binary cuts using Fenske, Underwood, Gilliland (Molokanov form), and McCabe-Thiele methods. Use when sizing a new column, screening separation feasibility, o"
...
source_path: "skills/distillation-shortcut-design/SKILL.md"
license: "MIT"
