...
description: ">- Fit Arrhenius parameters from k(T) data and size isothermal CSTR, PFR, or batch reactors for nth-order or arbitrary user-supplied rate laws. Includes N-CSTRs-in-series and a numeric PFR integrator. Use when designing or rating a reactor or fitting laboratory rate data. Don't use for non-isotherma"
...
source_path: "skills/reactor-sizing-and-kinetics/SKILL.md"
license: "MIT"
