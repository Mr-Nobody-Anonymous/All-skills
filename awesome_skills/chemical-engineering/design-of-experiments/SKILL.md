...
description: ">- Generate full-factorial and two-level factorial DOE plans with randomization support and compute main-effect estimates. Use when planning a small experimental campaign with 2-5 factors and a clear single response. Don't use for response-surface methodology (RSM is outside the scope), Plackett-Bur"
...
source_path: "skills/design-of-experiments/SKILL.md"
license: "MIT"
