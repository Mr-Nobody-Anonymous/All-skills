...
description: ">- Shared Python package used by all engineering skill scripts in this repository (JSON envelope, license-notification helper, dimensionless numbers, fluids/heat-transfer wrappers, VLE/separations/reactor helpers, compositional data, causal DAG, time-series, separator/valve helpers). Use when author"
...
source_path: "skills/engg-skills-common/SKILL.md"
license: "MIT"
