...
description: ">- LMTD-based duty and area estimate for counter- or co-current heat exchangers, with optional multi-pass F-factor correction (via `ht`). Use when sizing a new exchanger or sanity-checking an existing one with known U. Don't use for rigorous Bell-Delaware shell-side analysis, rate-based two-phase bo"
...
source_path: "skills/heat-exchanger-sizing/SKILL.md"
license: "MIT"
