...
description: ">- Fit finite-impulse-response (distributed-lag) models that relate a sampled process response (daily lab) to high-frequency inputs (DCS minute data) with smoothness-regularised lag coefficients. Use when the effect of an upstream change propagates with mixed-residence-time dynamics to a downstream"
...
source_path: "skills/distributed-lag-models/SKILL.md"
license: "MIT"
