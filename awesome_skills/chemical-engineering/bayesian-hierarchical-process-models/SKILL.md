...
description: ">- Fit Bayesian hierarchical (multi-level) regression models on process data using PyMC: campaign / regime random intercepts, censored likelihoods, AR(1) residuals, weakly informative priors. Use when you need calibrated uncertainty across regimes (campaigns, units, operators) or for partially poole"
...
source_path: "skills/bayesian-hierarchical-process-models/SKILL.md"
license: "MIT"
