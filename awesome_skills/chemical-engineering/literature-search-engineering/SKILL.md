...
description: ">- Search, screen, retrieve PDFs, and build literature-review matrices for engineering, applied-science, statistics, and physics topics using scholarly indexes (OpenAlex, Crossref, arXiv, Semantic Scholar, CORE, Scopus, PubMed Central, Google Scholar) and DOI-based PDF retrieval through open-access"
...
source_path: "skills/literature-search-engineering/SKILL.md"
license: "MIT"
