...
description: ">- Run vapor-liquid flash calculations, dew/bubble point solves, and Rachford-Rice K-value flashes for hydrocarbon, sour-gas, and light-process mixtures using Caleb Bell's `thermo` package. Use when the user needs phase split, K-values, dew/bubble pressure or temperature, or liquid/vapor properties"
...
source_path: "skills/vle-flash-calculations/SKILL.md"
license: "MIT"
