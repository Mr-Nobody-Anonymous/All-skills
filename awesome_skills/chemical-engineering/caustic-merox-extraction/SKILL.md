...
description: ">- Screening-level helpers for caustic mercaptan (Merox-style) extraction units: RS-Na loading in caustic, Kremser-style stage performance, and a disulfide carryback risk score. Use for plant troubleshooting, operator discussion, and order-of-magnitude estimation. Don't use for licensor design (use"
...
source_path: "skills/caustic-merox-extraction/SKILL.md"
license: "MIT"
