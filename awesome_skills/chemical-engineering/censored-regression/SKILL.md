...
description: ">- Fit censored-normal or censored-lognormal regression models for lab data reported as below-LOD, below-LOQ, above-range, or interval-censored. Use when fitting regressions on sulfur species, trace contaminants, or any analyte that is frequently censored. Don't use for ordinary uncensored regressio"
...
source_path: "skills/censored-regression/SKILL.md"
license: "MIT"
