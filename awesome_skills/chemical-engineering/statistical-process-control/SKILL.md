...
description: ">- Build individuals (I-MR) and X-bar / R control charts and compute basic process capability indices (Cp, Cpk) from quality-control data. Use when monitoring product quality on a stable process. Don't use on data that is strongly autocorrelated (use time-series-process-data-analysis to diagnose fir"
...
source_path: "skills/statistical-process-control/SKILL.md"
license: "MIT"
