...
description: ">- Transform compositional data (mole/mass fractions, GC compositions, sulfur speciation) using log-ratio transforms (clr, alr, ilr) and sequential binary partition (SBP)-based balances so regressions, PCA, and correlations are valid on the simplex. Use when analysing GC composition trends, sulfur-s"
...
source_path: "skills/compositional-data-analysis/SKILL.md"
license: "MIT"
