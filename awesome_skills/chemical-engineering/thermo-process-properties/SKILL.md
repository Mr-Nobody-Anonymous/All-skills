...
description: ">- Run Caleb Bell library-backed process property calculations: PR / Translated-PR cubic EOS for LPG and light hydrocarbon mixtures, COSTALD mixture liquid density (saturated and compressed), IAPWS water/steam state, and a transparent property-method recommendation heuristic modeled on DWSIM / Aspen"
...
source_path: "skills/thermo-process-properties/SKILL.md"
license: "MIT"
