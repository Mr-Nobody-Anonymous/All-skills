---
name: two-phase-flow
description: ">- Estimate frictional pressure drop for gas-liquid two-phase pipe flow using Lockhart-Martinelli (horizontal), Beggs-Brill (inclined, all angles), or Mueller-Steinhagen-Heck (smooth quality interpolation). Use when sizing flare lines, two-phase risers, knock-out drum inlets, or boiler-tube pressure"
...
source_path: "skills/two-phase-flow/SKILL.md"
license: "MIT"
