...
description: ">- Convert chemical/process engineering quantities between SI, US Customary, CGS, and mixed-unit forms with explicit dimensional checks. Use when an input is given in non-SI units or when an output needs to be reported in a different unit system. Don't use as a substitute for a property calculation"
...
source_path: "skills/process-units-conversion/SKILL.md"
license: "MIT"
