...
description: ">- Build a DAG for a process-data problem, test d-separation, enumerate back-door adjustment sets, and export to Graphviz DOT for review. Use when designing an observational study or distinguishing confounding from mediation. Don't use to estimate causal effects (that is a separate modelling task);"
...
source_path: "skills/process-causal-inference-dags/SKILL.md"
license: "MIT"
