...
description: ">- Size two-phase (gas-liquid) separator vessels (vertical or horizontal) using the Souders-Brown vapor-velocity criterion, K-factor heuristics, and liquid holdup time. Use when sizing flash drums, knock-out drums, suction scrubbers, or compressor inlet drums for screening. Don't use for three-phase"
...
source_path: "skills/separator-vessel-sizing/SKILL.md"
license: "MIT"
