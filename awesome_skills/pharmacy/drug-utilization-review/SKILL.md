...
description: |
  Design drug utilization review programs.
  TRIGGERS - Use when user needs help with drug-utilization-review related tasks.
category: Pharmacy
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/drug-utilization-review/SKILL.md"
license: "MIT"
