...
description: |
  Guide pharmacy regulatory compliance.
  TRIGGERS - Use when user needs help with pharmacy-compliance related tasks.
category: Pharmacy
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/pharmacy-compliance/SKILL.md"
license: "MIT"
