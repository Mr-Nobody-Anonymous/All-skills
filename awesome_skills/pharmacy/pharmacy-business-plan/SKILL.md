...
description: |
  Create pharmacy business plans.
  TRIGGERS - Use when user needs help with pharmacy-business-plan related tasks.
category: Pharmacy
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/pharmacy-business-plan/SKILL.md"
license: "MIT"
