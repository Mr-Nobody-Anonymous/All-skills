---
name: compounding-protocol
description: |
  Create compounding protocols and procedures.
  TRIGGERS - Use when user needs help with compounding-protocol related tasks.
category: Pharmacy
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/compounding-protocol/SKILL.md"
license: "MIT"
