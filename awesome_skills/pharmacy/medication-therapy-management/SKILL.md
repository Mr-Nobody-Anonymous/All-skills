...
description: |
  Design medication therapy management programs.
  TRIGGERS - Use when user needs help with medication-therapy-management related tasks.
category: Pharmacy
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/medication-therapy-management/SKILL.md"
license: "MIT"
