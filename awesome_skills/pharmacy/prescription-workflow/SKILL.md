...
description: |
  Design prescription processing workflows.
  TRIGGERS - Use when user needs help with prescription-workflow related tasks.
category: Pharmacy
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/prescription-workflow/SKILL.md"
license: "MIT"
