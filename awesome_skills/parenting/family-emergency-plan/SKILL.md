...
description: |
  Design family emergency plans.
  TRIGGERS - Use when user needs help with family-emergency-plan related tasks.
category: Parenting
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/family-emergency-plan/SKILL.md"
license: "MIT"
