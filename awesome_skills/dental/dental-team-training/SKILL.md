---
name: dental-team-training
description: |
  Design training programs for dental teams.
  TRIGGERS - Use when user needs help with dental-team-training related tasks.
category: Dental
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/dental-team-training/SKILL.md"
license: "MIT"
