---
name: dental-practice-plan
description: |
  Create dental practice business plans.
  TRIGGERS - Use when user needs help with dental-practice-plan related tasks.
category: Dental
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/dental-practice-plan/SKILL.md"
license: "MIT"
