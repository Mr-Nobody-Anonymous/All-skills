---
name: dental-patient-recall
description: |
  Design patient recall systems for dental practices.
  TRIGGERS - Use when user needs help with dental-patient-recall related tasks.
category: Dental
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/dental-patient-recall/SKILL.md"
license: "MIT"
