---
name: dental-website-copy
description: |
  Write dental practice website copy.
  TRIGGERS - Use when user needs help with dental-website-copy related tasks.
category: Dental
version: 1.0
source: "https://github.com/Winbda/claude-skills-collection"
source_repository: "Winbda/claude-skills-collection"
source_path: "skills/dental-website-copy/SKILL.md"
license: "MIT"
