---
name: pet-photography-guide
description: |
  Create pet photography guides with techniques.
  TRIGGERS - Use when user needs help with pet-photography-guide related tasks.
...
source_path: "skills/pet-photography-guide/SKILL.md"
license: "MIT"
