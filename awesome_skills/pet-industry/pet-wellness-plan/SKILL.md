---
name: pet-wellness-plan
description: |
  Create pet wellness plans with preventive care.
  TRIGGERS - Use when user needs help with pet-wellness-plan related tasks.
...
source_path: "skills/pet-wellness-plan/SKILL.md"
license: "MIT"
