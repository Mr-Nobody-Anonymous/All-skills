---
name: pet-adoption-program
description: |
  Design pet adoption programs with processes.
  TRIGGERS - Use when user needs help with pet-adoption-program related tasks.
...
source_path: "skills/pet-adoption-program/SKILL.md"
license: "MIT"
