---
name: pet-daycare-operations
description: |
  Design pet daycare operations with safety.
  TRIGGERS - Use when user needs help with pet-daycare-operations related tasks.
...
source_path: "skills/pet-daycare-operations/SKILL.md"
license: "MIT"
