...
description: |
  Create pet nutrition guides with feeding plans.
  TRIGGERS - Use when user needs help with pet-nutrition-guide related tasks.
...
source_path: "skills/pet-nutrition-guide/SKILL.md"
license: "MIT"
