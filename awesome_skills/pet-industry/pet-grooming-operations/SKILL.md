---
name: pet-grooming-operations
description: |
  Design pet grooming operations with standards.
  TRIGGERS - Use when user needs help with pet-grooming-operations related tasks.
...
source_path: "skills/pet-grooming-operations/SKILL.md"
license: "MIT"
