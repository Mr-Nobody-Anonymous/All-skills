---
name: pet-business-plan
description: |
  Create pet business plans with market analysis.
  TRIGGERS - Use when user needs help with pet-business-plan related tasks.
...
source_path: "skills/pet-business-plan/SKILL.md"
license: "MIT"
