---
name: pet-product-launch
description: |
  Launch pet products with marketing and distribution.
  TRIGGERS - Use when user needs help with pet-product-launch related tasks.
...
source_path: "skills/pet-product-launch/SKILL.md"
license: "MIT"
