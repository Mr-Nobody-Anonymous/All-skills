...
description: |
  Design pet training programs with methods.
  TRIGGERS - Use when user needs help with pet-training-program related tasks.
...
source_path: "skills/pet-training-program/SKILL.md"
license: "MIT"
