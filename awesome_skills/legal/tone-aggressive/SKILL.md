...
source_path: "skills/legal/tone-aggressive/SKILL.md"
license: "Apache-2.0"
...
1. Identify the strongest factual point — lead with it
2. Replace hedging language ("may," "might," "arguably") with declaratives ("is," "was," "conclusively")
3. Frame around opposing party's failures first, then client's strength
4. Anchor every assertion to an exhibit, transcript page, or statutory provision
