...
description: >-
  ...
  preparation, and appeal. Produces case theory analysis, chronologies from
  document sets, discovery plans, deposition outlines, brief drafts,
  cross-examination questions, and appellate record summaries. Use when
  evaluating a new litigation matter, preparing case strategy memos,
  building case chronologies from emails or documents, preparing for
  depositions, drafting motions or briefs, developing trial strategy, or
  preparing appellate filings. Trigger keywords: litigation strategy, case
  assessment, case theory, case chronology, discovery plan, deposition prep,
  motion to dismiss, summary judgment, trial preparation, cross-examination,
  appellate brief, argument evaluation, case timeline.
metadata:
  author: casemark
  practice_areas:
    - Litigation
...
source_path: "skills/legal/litigation-case-strategy/SKILL.md"
license: "Apache-2.0"
