...
<p align="center">
  <img src="https://img.shields.io/badge/skills-12217%2B%20Total%20Skills-7c3aed?style=for-the-badge&logo=codewars&logoColor=white" alt="2167+ Skills" />
  <img src="https://img.shields.io/badge/awesome--catalog-14174%20Categorized-0ea5e9?style=for-the-badge&logo=github&logoColor=white" alt="2041 Awesome Skills" />
...
<p align="center">
  <strong>A comprehensive, extensible Agent Skills platform & discovery engine. Over 12,217 unique skills across 218 domain categories, 70 pre-loaded staff-engineer playbooks, 122 canonical tested skills, machine-readable dependency & conflict graphs, confidence thresholding with out-of-domain rejection, capability security enforcement, reproducible lockfiles, and native multi-tool compatibility across Claude Code, Cursor, Codex CLI, and Antigravity.</strong>
</p>
...
│                               │                                 │     .cursor/ / .codex/)       │
├───────────────────────────────┼─────────────────────────────────┼───────────────────────────────┤
│  • 122 Curated & Tested Skills│  • 14,174 Categorized Skills     │  • 70 Staff Engineer Skills   │
│  • 9-Signal Layered Scoring   │  • 218 Functional Domain Dirs   │  • Pre-Loaded in Workspace    │
...
2. **Master Intent Router (`which-skill`)**: [`.agents/skills/which-skill/SKILL.md`](.agents/skills/which-skill/SKILL.md) provides instant decision matrix mapping and CLI routing (`python scripts/skills/skills.py route`) across all 14,174+ skills.
...
- `which-skill` — Master agent intent router across all 14,174+ skills and workflows
...
Interact with all 14,174+ categorized skills in [`awesome_skills/`](awesome_skills/):

```bash
# List all 218 domain categories with skill counts
...
# Fuzzy search across all 14,174+ skills by keyword
...
│   ├── skills_index.json        # 14,174-item metadata database
